---
title: Android Screen Stuck General ZTE Nubia Z60 Ultra Partly Screen Unresponsive | Dr.fone
date: 2024-07-30T09:20:18.673Z
updated: 2024-07-31T09:20:18.673Z
tags: 
  - problems
categories:
  - android
description: This article describes Android Screen Stuck General ZTE Nubia Z60 Ultra Partly Screen Unresponsive
excerpt: This article describes Android Screen Stuck General ZTE Nubia Z60 Ultra Partly Screen Unresponsive
keywords: android repair,ZTE Nubia Z60 Ultra android solutions,ZTE Nubia Z60 Ultra android fix,ZTE Nubia Z60 Ultra android troubleshooting,android issues,android troubleshooting
...
<!-- affiliate ads end -->
## 7 Fixes for "Unfortunately, Phone Has Stopped" on ZTE Nubia Z60 Ultra
...
First and foremost, the thing that can let you get rid of this trouble is Safe Mode. It is a feature that will end any excessive background functioning of the ZTE Nubia Z60 Ultra device. For instance, your device will be able to run sans any third-party apps when in Safe mode. Since the important functions and the naïve apps will be running on the ZTE Nubia Z60 Ultra device, you will get to know if it’s really a software glitch or not by running the Phone app in Safe mode. And this is the first solution we would recommend you make use of when the Phone app has stopped. Here is how to enable Safe Mode.

1. Switch off the ZTE Nubia Z60 Ultra phone first.
2. Now keep pressing the "Power" button until you see the ZTE Nubia Z60 Ultra logo on the screen.
3. Release the button and immediately press and hold the "Volume Down" key.
4. Leave the key once the ZTE Nubia Z60 Ultra device is in Safe mode. Now, the third-party apps will be disabled and you can check if the Phone app is still not responding or everything is fine.
...
### 2.4 Update the ZTE Nubia Z60 Ultra firmware

When the firmware is not updated, it may conflict with some apps and maybe that’s why your Phone app falls prey. Therefore, updating ZTE Nubia Z60 Ultra firmware will be a sane step that should be taken when the Phone app has stopped. Follow the below-mentioned steps and then check if the Phone app is opening or not.
...
Here is another resolution for the "Unfortunately Phone has stopped" error. Clearing the partition cache will remove the whole cache of the ZTE Nubia Z60 Ultra device and make it work like before.
...
5. The process will begin and the ZTE Nubia Z60 Ultra device will restart post it. Check if the problem still persists or it is finished. If unfortunately not, get to the next and the most productive solution.
...
<!-- affiliate ads end -->
### 2.6 Get the ZTE Nubia Z60 Ultra system repaired in one click
...
Android repair tool to fix "Unfortunately, Phone Has Stopped" on ZTE Nubia Z60 Ultra devices.

- It takes no special skills to operate it and fairly works to bring the Android system to normalcy.
- It shows great compatibility with all ZTE Nubia Z60 Ultra devices and other Android phones supporting over 1000 Android brands.
...
Take your original USB cord and then connect your ZTE Nubia Z60 Ultra to the computer. When the ZTE Nubia Z60 Ultra device is connected, click on "Android" from the two tabs > click "Start"
...
As the next step, enter some important details on the next screen. Be sure to enter the right name, brand, and model of the ZTE Nubia Z60 Ultra device. When done everything, verify once and click on "Next".
...
**Step 5: Get the ZTE Nubia Z60 Ultra device Repaired**

When you see the firmware has been downloaded, the issue will begin to get resolved. Hang on and wait until you get notified for the repair of the ZTE Nubia Z60 Ultra device.
