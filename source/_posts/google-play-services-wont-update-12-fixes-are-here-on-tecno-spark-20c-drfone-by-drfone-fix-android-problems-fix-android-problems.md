---
title: Google Play Services Wont Update? 12 Fixes are Here on Tecno Spark 20C | Dr.fone
date: 2024-11-09T00:06:28.240Z
updated: 2024-11-11T22:03:17.711Z
tags: 
  - problems
categories:
  - android
description: This article describes Google Play Services Wont Update? 12 Fixes are Here on Tecno Spark 20C
excerpt: This article describes Google Play Services Wont Update? 12 Fixes are Here on Tecno Spark 20C
keywords: Tecno Spark 20C android tips,android fix,Tecno Spark 20C fix android problems,android guide,Tecno Spark 20C android solutions,Tecno Spark 20C android support
thumbnail: https://thmb.techidaily.com/1296bc6cf3d8ba602cee83fbaf9d9aae0f41d750526e3d62954932be609de318.jpg
---

## Google Play Services Won't Update? 12 Fixes are Here on Tecno Spark 20C
...
- **1\. Incompatibility with Custom ROMs:** Using a custom ROM on your Tecno Spark 20C can cause compatibility issues and prevent the installation of Google Play Services updates.
...
Now, taking the assistance of an original USB cable, connect your Tecno Spark 20C to the PC. Then hit on “Start”.
...
In most cases, restarting the Tecno Spark 20C device can simply do the trick. When you restart the Tecno Spark 20C device, most of the issues get eliminated making the Tecno Spark 20C device perform better than before. Also, it is all about RAM. While you restart your device, the RAM gets cleared. As a result, the apps work properly. So, in the first place, we would like you to restart your Tecno Spark 20C when you cannot update Google Play Services. Once restarted, try to update again and see if the results are positive.
...
If unfortunately, things are still the same, we would like to recommend you wipe the cache of the whole device to fix the issue. This is an advanced method to solve issues and is helpful when the Tecno Spark 20C device is facing any flaws or malfunctions. For this, you need to go to the download mode or recovery mode of your device. Every device has its own steps for this. Like in some, you need to simultaneously press the “Power” and “Volume Down” keys. While in some, the “Power” and both “Volume” keys work.
...
- Turn off the Tecno Spark 20C device to begin with and then follow the steps for recovery mode.
- On the recovery screen, use the “Volume” buttons for scrolling up and down and go to “Wipe cache partition”.
- To confirm, press the “Power” button. Now, the Tecno Spark 20C device will begin to wipe the cache.
- Hit reboot when asked and the Tecno Spark 20C device will now be rebooted finishing the issue.
...
Some devices aggressively optimize battery usage, which can interfere with the background processes required for updating Google Play Services. Disable battery optimization for Google Play Services in the Tecno Spark 20C device's Settings to ensure uninterrupted updates.
...
As a final measure, if everything went in vain, you can perform a factory reset on your device. This method will wipe away all your data while performing and make the Tecno Spark 20C device go to factory state. Please ensure to keep backing up your important data if you are going to take the help of this method.
...
To check the version of Google Play Services on your Tecno Spark 20C, follow these steps:
