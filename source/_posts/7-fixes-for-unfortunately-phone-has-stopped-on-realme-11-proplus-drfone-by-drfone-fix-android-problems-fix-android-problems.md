---
title: 7 Fixes for Unfortunately, Phone Has Stopped on Realme 11 Pro+ | Dr.fone
date: 2024-05-20T09:03:25.787Z
updated: 2024-05-21T09:03:25.787Z
tags: 
  - problems
categories:
  - android
description: This article describes 7 Fixes for Unfortunately, Phone Has Stopped on Realme 11 Pro+
excerpt: This article describes 7 Fixes for Unfortunately, Phone Has Stopped on Realme 11 Pro+
keywords: Realme 11 Pro+ android troubleshooting,Realme 11 Pro+ android tips,Realme 11 Pro+ android guide,android fix,Realme 11 Pro+ android fix,android issues,Realme 11 Pro+ android repair,Realme 11 Pro+ android problems,android guide
...
## Google Play Services Won't Update? 12 Fixes are Here on Realme 11 Pro+
...
- **1\. Incompatibility with Custom ROMs:** Using a custom ROM on your Realme 11 Pro+ can cause compatibility issues and prevent the installation of Google Play Services updates.
...
Now, taking the assistance of an original USB cable, connect your Realme 11 Pro+ to the PC. Then hit on “Start”.
...
In most cases, restarting the Realme 11 Pro+ device can simply do the trick. When you restart the Realme 11 Pro+ device, most of the issues get eliminated making the Realme 11 Pro+ device perform better than before. Also, it is all about RAM. While you restart your device, the RAM gets cleared. As a result, the apps work properly. So, in the first place, we would like you to restart your Realme 11 Pro+ when you cannot update Google Play Services. Once restarted, try to update again and see if the results are positive.
...
If unfortunately, things are still the same, we would like to recommend you wipe the cache of the whole device to fix the issue. This is an advanced method to solve issues and is helpful when the Realme 11 Pro+ device is facing any flaws or malfunctions. For this, you need to go to the download mode or recovery mode of your device. Every device has its own steps for this. Like in some, you need to simultaneously press the “Power” and “Volume Down” keys. While in some, the “Power” and both “Volume” keys work.
...
- Turn off the Realme 11 Pro+ device to begin with and then follow the steps for recovery mode.
- On the recovery screen, use the “Volume” buttons for scrolling up and down and go to “Wipe cache partition”.
- To confirm, press the “Power” button. Now, the Realme 11 Pro+ device will begin to wipe the cache.
- Hit reboot when asked and the Realme 11 Pro+ device will now be rebooted finishing the issue.
...
Some devices aggressively optimize battery usage, which can interfere with the background processes required for updating Google Play Services. Disable battery optimization for Google Play Services in the Realme 11 Pro+ device's Settings to ensure uninterrupted updates.
...
As a final measure, if everything went in vain, you can perform a factory reset on your device. This method will wipe away all your data while performing and make the Realme 11 Pro+ device go to factory state. Please ensure to keep backing up your important data if you are going to take the help of this method.
...
To check the version of Google Play Services on your Realme 11 Pro+, follow these steps:
