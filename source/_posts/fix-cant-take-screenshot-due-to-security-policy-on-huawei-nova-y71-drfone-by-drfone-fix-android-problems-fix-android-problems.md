---
title: Fix Cant Take Screenshot Due to Security Policy on Huawei Nova Y71 | Dr.fone
date: 2024-07-30T10:14:04.008Z
updated: 2024-07-31T10:14:04.008Z
tags: 
  - problems
categories:
  - android
description: This article describes Fix Cant Take Screenshot Due to Security Policy on Huawei Nova Y71
excerpt: This article describes Fix Cant Take Screenshot Due to Security Policy on Huawei Nova Y71
keywords: Huawei Nova Y71 android troubleshooting,Huawei Nova Y71 android repair,Huawei Nova Y71 android tips,android tips,android problems,android help,Huawei Nova Y71 android fix,Huawei Nova Y71 android support
...
Authentication error occurs when the “deal” between the Wi-Fi router and device fails due to certain reasons. First, the Huawei Nova Y71 device sends the password of the network and the "connect" request in an encrypted format to the Wi-Fi router. Then, the router decrypts the password and compares the password saved on it. Now, if the password matches, it sends affirmation for the "connect" request, and then the Huawei Nova Y71 device is allowed to connect to the network.
...
1. Connect your Huawei Nova Y71 to the computer, and select "Android Repair" in the middle.
...
1. Next up, you should boot your Huawei Nova Y71 in download mode by following the on-screen instructions.
...
Step 1: Head to the “Settings” of your Huawei Nova Y71 and then opt for “Wireless and Networks” followed by “WLAN/WiFi”.

Step 2: Now, hit on the WiFi network that is showing "authentication error occurred".

Step 3: Depending on your Huawei Nova Y71 model, look for “IP Settings” and tap on it. Now, switch the “DHCP” to “Static”.
...
There are instances where an outdated OS version of your Huawei Nova Y71 may create a hindrance in establishing a connection between your device and the WiFi network. You need to update your Android firmware to the latest version and then check if the problem persists or not.

Step 1: Launch “Settings” of your Huawei Nova Y71 and then get into the “About Phone” option.
