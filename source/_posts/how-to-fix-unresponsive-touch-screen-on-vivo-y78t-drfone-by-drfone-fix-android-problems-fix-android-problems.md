---
title: How To Fix Unresponsive Touch Screen on Vivo Y78t | Dr.fone
...
categories:
  - android
description: This article describes How To Fix Unresponsive Touch Screen on Vivo Y78t
excerpt: This article describes How To Fix Unresponsive Touch Screen on Vivo Y78t
keywords: Vivo Y78t android solutions,android guide,Vivo Y78t android problems,android troubleshooting,Vivo Y78t android support,android tips,Vivo Y78t fix android problems,Vivo Y78t android tips,android fix,Vivo Y78t android help
thumbnail: https://www.lifewire.com/thmb/eYqxG8EorGAmKcW0zOiG4PnWFkw=/400x300/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/homeweatherstation-34f9e9a9aaf64446a8f21ff05991c079.jpg
---

## How To Fix Unresponsive Touch Screen on Vivo Y78t
...
## Part 2: Tips, Fixes, and Workarounds To Fix Your Vivo Y78t Touch Problems
...
Placing your Android into **Recovery Mode** is different depending on your Android smartphone. Refer to your owner’s manual to see which method is right for your Vivo Y78t.
...
**Step 1B**: If your Vivo Y78t still has a **Home** button, press and hold the **Home** button and the **Power** button at the same time. Continue holding them until the screen starts.
...
The program supports almost all Vivo Y78t models and other Android devices, whether unlocked or from a carrier. Dr.Fone is equipped with all the proper firmware to flash your Vivo Y78t with just a few clicks. In addition, it has handy on-screen instructions to help you complete the whole process with ease.
...
- The fast processing time to fix your Vivo Y78t means you can do more in less time.

**Cons**

- The free version only works until you see if your Vivo Y78t is compatible with the app. You will be required to enter a valid license once you initiate the repair process.
...
**Step 1**: Download and install Wondershare Dr.Fone on your computer. Next, launch the program and connect your Vivo Y78t to your computer.

![dr.fone general phone screen problems 01](https://images.wondershare.com/drfone/guide/android-system-repair-1.png)

**Step 2:** Click **Start** to initiate the setup on a new window. From there, select the **Brand, Name, Model, Country,** and **Carrier** of your Vivo Y78t and click **Next**.
...
Authentication error occurs when the “deal” between the Wi-Fi router and device fails due to certain reasons. First, the Vivo Y78t device sends the password of the network and the "connect" request in an encrypted format to the Wi-Fi router. Then, the router decrypts the password and compares the password saved on it. Now, if the password matches, it sends affirmation for the "connect" request, and then the Vivo Y78t device is allowed to connect to the network.
...
- Supports all the new Vivo Y78t devices like Galaxy S8, S9, etc.
...
1. Connect your Vivo Y78t to the computer, and select "Android Repair" in the middle.
...
1. Next up, you should boot your Vivo Y78t in download mode by following the on-screen instructions.
...
Step 1: Head to the “Settings” of your Vivo Y78t and then opt for “Wireless and Networks” followed by “WLAN/WiFi”.

Step 2: Now, hit on the WiFi network that is showing "authentication error occurred".

Step 3: Depending on your Vivo Y78t model, look for “IP Settings” and tap on it. Now, switch the “DHCP” to “Static”.
...
There are instances where an outdated OS version of your Vivo Y78t may create a hindrance in establishing a connection between your device and the WiFi network. You need to update your Android firmware to the latest version and then check if the problem persists or not.

Step 1: Launch “Settings” of your Vivo Y78t and then get into the “About Phone” option.
