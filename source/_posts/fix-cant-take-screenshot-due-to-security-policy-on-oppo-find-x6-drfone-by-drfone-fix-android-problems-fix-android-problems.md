---
title: Fix Cant Take Screenshot Due to Security Policy on Oppo Find X6 | Dr.fone
date: 2024-07-30T10:16:37.530Z
updated: 2024-07-31T10:16:37.530Z
tags: 
  - problems
categories:
  - android
description: This article describes Fix Cant Take Screenshot Due to Security Policy on Oppo Find X6
excerpt: This article describes Fix Cant Take Screenshot Due to Security Policy on Oppo Find X6
keywords: android guide,android repair,android issues,Oppo Find X6 android fix,Oppo Find X6 android guide,Oppo Find X6 android support,Oppo Find X6 android troubleshooting,android problems,Oppo Find X6 android problems,Oppo Find X6 android help,android fix
thumbnail: https://thmb.techidaily.com/056b5dc5bf38553fc5e62980ac558058cdfef6fae043dca04e140a16eeec969f.jpg
---

## Fix Can't Take Screenshot Due to Security Policy on Oppo Find X6
...
Say you’re trying to take a screenshot on your Oppo Find X6 device, and you get the notification “**Can’t take screenshot due to security policy.” Oppo Find X6** smartphones are not necessarily the problem.
...
Sudden “**can’t take screenshot due to security policy**” notifications, failing to take a screenshot, and a Oppo Find X6 user?
...
- **Step 3:** Enable **Oppo Find X6 capture**.
...
- **Step 1:** Open Chrome on your Oppo Find X6 and type “chrome://flags” in the address bar.
...
With Google Assistant, taking screenshots on your Oppo Find X6 is now easier than ever. Just say, “Hey, Google, take a screenshot,” Google Assistant will capture the screen and save it to your gallery.
...
Smart View allows you to display your Oppo Find X6 device’s screen on your smart TV, where you can then take a screenshot of the TV to capture the app or website you need.
...
Alternatively, if you don’t have a smart TV, you can still mirror your phone screen display to your desktop or tablet using the Oppo Find X6 Flow app and take a screenshot of your phone’s screen instead.
...
- **Step 1:** Once you have downloaded Dr.Fone, install it and launch it on your desktop. Then, connect your Oppo Find X6 to your desktop using a USB cable.
...
- **Step 5:** Follow the in-app instructions to put your Oppo Find X6 on Download mode, then click **Next**.
...
Here are some common reasons why your Oppo Find X6 is bricked:
...
- **Rooting an Android device:**You are unable to effectively root the Oppo Find X6 device.
- **Android firmware is being updated:**If the phone is interrupted when updating the Android firmware, it will be bricked.
- **Installing harmful applications:**You installed harmful programs on your Oppo Find X6, or the phone was infected with a virus.
...
To repair bricked Android phones and tablets, you must first thoroughly examine the Oppo Find X6 device's state. Before you begin troubleshooting, determine the sort of bricking that your phone is experiencing. However, there is no specific software to unbrick your Oppo Find X6; you may need to learn the complexities of this issue or hire a professional to do it for you.
...
- **Step 1:** Save the required ROM (in ZIP format) to an SD card. The SD card should then be inserted into your Oppo Find X6.
...
While it is not an Android unbrick tool, it is a useful tool for retrieving data when your Oppo Find X6 becomes bricked. It is quite easy to use:
...
How to prevent a device from “bricking” itself and how to repair it if it does The delay is set by the MCU, but it should be long enough to allow the debug adapter to connect to the Oppo Find X6 device and halt it before the Oppo Find X6 device disables itself.
