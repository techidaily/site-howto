---
title: Honor X8b Stuck on Screen – Finding Solutions For Stuck on Boot | Dr.fone
date: 2024-03-18 10:26:34
updated: 2024-03-21 23:23:52
tags: 
  - problems
categories:
  - android
description: This article describes Honor X8b Stuck on Screen – Finding Solutions For Stuck on Boot
excerpt: This article describes Honor X8b Stuck on Screen – Finding Solutions For Stuck on Boot
keywords: Honor X8b android solutions,android help,android support,fix android problems,Honor X8b android tips,Honor X8b android guide,Honor X8b android support
...
## 6 Solutions to Fix Error 505 in Google Play Store on Honor X8b
...
- Supports all the new Honor X8b devices like Galaxy S8, S9, etc.
...
Step5: After the Honor X8b device firmware is downloaded, the tool will start repairing your Android.
...
\>Select the Application Manger or App (Option depends upon the Honor X8b device)

At the top, an option will appear

\>Swipe right till you locate Download manager at top of the screen of the Honor X8b device

\>Then Select Enable

![Application Manger](https://images.wondershare.com/drfone/article/2017/06/14976274734570.jpg)

Enabling download manager to give permission to the Honor X8b device to start the download or installation process.

#### **Solution 3: Updating to the latest version of OS of your Honor X8b**
...
## Google Play Services Won't Update? 12 Fixes are Here on Honor X8b
...
- **1\. Incompatibility with Custom ROMs:** Using a custom ROM on your Honor X8b can cause compatibility issues and prevent the installation of Google Play Services updates.
...
Now, taking the assistance of an original USB cable, connect your Honor X8b to the PC. Then hit on “Start”.
...
In most cases, restarting the Honor X8b device can simply do the trick. When you restart the Honor X8b device, most of the issues get eliminated making the Honor X8b device perform better than before. Also, it is all about RAM. While you restart your device, the RAM gets cleared. As a result, the apps work properly. So, in the first place, we would like you to restart your Honor X8b when you cannot update Google Play Services. Once restarted, try to update again and see if the results are positive.
...
- Turn off the Honor X8b device to begin with and then follow the steps for recovery mode.
- On the recovery screen, use the “Volume” buttons for scrolling up and down and go to “Wipe cache partition”.
- To confirm, press the “Power” button. Now, the Honor X8b device will begin to wipe the cache.
- Hit reboot when asked and the Honor X8b device will now be rebooted finishing the issue.
...
Some devices aggressively optimize battery usage, which can interfere with the background processes required for updating Google Play Services. Disable battery optimization for Google Play Services in the Honor X8b device's Settings to ensure uninterrupted updates.
...
To check the version of Google Play Services on your Honor X8b, follow these steps:
