---
title: Google Play Services Wont Update? 12 Fixes are Here on Honor Magic V2 | Dr.fone
date: 2024-07-30T11:21:43.963Z
updated: 2024-07-31T11:21:43.963Z
tags: 
  - problems
categories:
  - android
description: This article describes Google Play Services Wont Update? 12 Fixes are Here on Honor Magic V2
excerpt: This article describes Google Play Services Wont Update? 12 Fixes are Here on Honor Magic V2
keywords: android guide,Honor Magic V2 android fix,Honor Magic V2 android issues,android fix,android support,android issues,android troubleshooting,Honor Magic V2 android troubleshooting,Honor Magic V2 android solutions,android repair,android tips,Honor Magic V2 android problems
thumbnail: https://thmb.techidaily.com/bedeaab43df1b8b5afd8fae799c1b0ff2cb5a9adc8ca952932303c5e2c53ba39.jpg
---

## Google Play Services Won't Update? 12 Fixes are Here on Honor Magic V2
...
- **1\. Incompatibility with Custom ROMs:** Using a custom ROM on your Honor Magic V2 can cause compatibility issues and prevent the installation of Google Play Services updates.
...
Now, taking the assistance of an original USB cable, connect your Honor Magic V2 to the PC. Then hit on “Start”.
...
In most cases, restarting the Honor Magic V2 device can simply do the trick. When you restart the Honor Magic V2 device, most of the issues get eliminated making the Honor Magic V2 device perform better than before. Also, it is all about RAM. While you restart your device, the RAM gets cleared. As a result, the apps work properly. So, in the first place, we would like you to restart your Honor Magic V2 when you cannot update Google Play Services. Once restarted, try to update again and see if the results are positive.
...
If unfortunately, things are still the same, we would like to recommend you wipe the cache of the whole device to fix the issue. This is an advanced method to solve issues and is helpful when the Honor Magic V2 device is facing any flaws or malfunctions. For this, you need to go to the download mode or recovery mode of your device. Every device has its own steps for this. Like in some, you need to simultaneously press the “Power” and “Volume Down” keys. While in some, the “Power” and both “Volume” keys work.
...
- Turn off the Honor Magic V2 device to begin with and then follow the steps for recovery mode.
- On the recovery screen, use the “Volume” buttons for scrolling up and down and go to “Wipe cache partition”.
- To confirm, press the “Power” button. Now, the Honor Magic V2 device will begin to wipe the cache.
- Hit reboot when asked and the Honor Magic V2 device will now be rebooted finishing the issue.
...
Some devices aggressively optimize battery usage, which can interfere with the background processes required for updating Google Play Services. Disable battery optimization for Google Play Services in the Honor Magic V2 device's Settings to ensure uninterrupted updates.
...
As a final measure, if everything went in vain, you can perform a factory reset on your device. This method will wipe away all your data while performing and make the Honor Magic V2 device go to factory state. Please ensure to keep backing up your important data if you are going to take the help of this method.
...
To check the version of Google Play Services on your Honor Magic V2, follow these steps:
...
<!-- affiliate ads end -->
## 7 Solutions to Fix Error Code 963 on Google Play Of Honor Magic V2
...
**Note:** _Before moving to solve the error 963, we would like to inform you that the process may result in wiping away your data. And therefore, we suggest you to [make backup of your Honor Magic V2](https://tools.techidaily.com/wondershare/drfone/android-backup-and-restore/) prior to fixing this Google Play error 963__._

**Phase 1: Connecting and preparing the Honor Magic V2 device**

Step 1 – To begin fixing error 963, run Dr.Fone after downloading and installing it on your PC. Now, pick out the ‘System Repair’ tab from the main screen. Thereupon, with the help of a USB cable, make connection between your Honor Magic V2 and PC
...
Step 1 – It is essential to get your Honor Magic V2 or tablet entered in Download mode. For this, following are the steps to be taken:

If the Honor Magic V2 device contains Home button:

- Turn the Honor Magic V2 device off and then keep holding the ‘Power’, ‘Volume Down’ and ‘Home’ buttons altogether for about 10 seconds. Next, release them all and push the ‘Volume Up’ key. This way, your device will enter the Download mode.
...
If the Honor Magic V2 device contains no Home button:
...
This method is strictly for certain Apps which cannot be updated because they are stored on an external memory card, i.e., SD Card. Such memory enhancing chips do not support large Apps and due to a shortage of space prevents them from updating. It advisable to move such Apps from the SD Card to the Honor Magic V2 device’s internal memory and then try to update it.
...
## What To Do if Your Honor Magic V2 Auto Does Not Work
...
If navigating through various troubleshooting steps seems complicated, especially if the issue resides within your Honor Magic V2, a swift and efficient solution comes in the form of Wondershare Dr.Fone - System Repair.
...
- **Step 1:** Begin by launching Dr.Fone on your computer. From the left panel, access the Toolbox menu and click **System Repair**. Ensure your Honor Magic V2 is connected.
