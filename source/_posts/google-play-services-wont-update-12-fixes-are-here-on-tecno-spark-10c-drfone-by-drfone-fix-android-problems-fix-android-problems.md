---
title: Google Play Services Wont Update? 12 Fixes are Here on Tecno Spark 10C | Dr.fone
date: 2024-11-06T08:49:17.110Z
updated: 2024-11-11T20:57:06.710Z
tags: 
  - problems
categories:
  - android
description: This article describes Google Play Services Wont Update? 12 Fixes are Here on Tecno Spark 10C
excerpt: This article describes Google Play Services Wont Update? 12 Fixes are Here on Tecno Spark 10C
keywords: Tecno Spark 10C android issues,Tecno Spark 10C android solutions,Tecno Spark 10C android help,Tecno Spark 10C android tips,Tecno Spark 10C android support,Tecno Spark 10C android repair,Tecno Spark 10C android troubleshooting,fix android problems,android guide
thumbnail: https://thmb.techidaily.com/4f556f53b702be059c5baaa605e55372122aad0cd1b5268a8b5026540ff9ee16.jpg
---

## Google Play Services Won't Update? 12 Fixes are Here on Tecno Spark 10C
...
- **1\. Incompatibility with Custom ROMs:** Using a custom ROM on your Tecno Spark 10C can cause compatibility issues and prevent the installation of Google Play Services updates.
...
Now, taking the assistance of an original USB cable, connect your Tecno Spark 10C to the PC. Then hit on “Start”.
...
In most cases, restarting the Tecno Spark 10C device can simply do the trick. When you restart the Tecno Spark 10C device, most of the issues get eliminated making the Tecno Spark 10C device perform better than before. Also, it is all about RAM. While you restart your device, the RAM gets cleared. As a result, the apps work properly. So, in the first place, we would like you to restart your Tecno Spark 10C when you cannot update Google Play Services. Once restarted, try to update again and see if the results are positive.
...
If unfortunately, things are still the same, we would like to recommend you wipe the cache of the whole device to fix the issue. This is an advanced method to solve issues and is helpful when the Tecno Spark 10C device is facing any flaws or malfunctions. For this, you need to go to the download mode or recovery mode of your device. Every device has its own steps for this. Like in some, you need to simultaneously press the “Power” and “Volume Down” keys. While in some, the “Power” and both “Volume” keys work.
...
- Turn off the Tecno Spark 10C device to begin with and then follow the steps for recovery mode.
- On the recovery screen, use the “Volume” buttons for scrolling up and down and go to “Wipe cache partition”.
- To confirm, press the “Power” button. Now, the Tecno Spark 10C device will begin to wipe the cache.
- Hit reboot when asked and the Tecno Spark 10C device will now be rebooted finishing the issue.
...
Some devices aggressively optimize battery usage, which can interfere with the background processes required for updating Google Play Services. Disable battery optimization for Google Play Services in the Tecno Spark 10C device's Settings to ensure uninterrupted updates.
...
As a final measure, if everything went in vain, you can perform a factory reset on your device. This method will wipe away all your data while performing and make the Tecno Spark 10C device go to factory state. Please ensure to keep backing up your important data if you are going to take the help of this method.
...
To check the version of Google Play Services on your Tecno Spark 10C, follow these steps:
...
## Tecno Spark 10C Camera Not Working Unexpected Error? Fix It Now
...
There are a few reasons why the camera app is not working on your Tecno Spark 10C.
...
In the rarest cases, there might have developed an actual hardware issue with the camera system on your Tecno Spark 10C. The likely culprit is misuse and abuse, such as a dropped phone or maybe the phone was too hot for extended periods of time, causing hardware issues.

## Part II: How To Fix Android Camera Not Working Issue?

So, how to get the Android camera not working problem solved? There are a few ways you can try fixing the camera not working issue on your Tecno Spark 10C right where you are, without needing to take the Tecno Spark 10C device to the manufacturer’s service center.

### II.I: Restart The Handset

One of the first things to do any time an app or your phone or tablet does not work like it should, restarting the Tecno Spark 10C device refreshes everything just enough to resolve most commonly occurring issues.
