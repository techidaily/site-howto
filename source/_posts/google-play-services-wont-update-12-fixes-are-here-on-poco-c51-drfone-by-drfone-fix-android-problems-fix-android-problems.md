---
title: Google Play Services Wont Update? 12 Fixes are Here on Poco C51 | Dr.fone
date: 2024-07-30T11:24:55.665Z
updated: 2024-07-31T11:24:55.665Z
tags: 
  - problems
categories:
  - android
description: This article describes Google Play Services Wont Update? 12 Fixes are Here on Poco C51
excerpt: This article describes Google Play Services Wont Update? 12 Fixes are Here on Poco C51
keywords: Poco C51 android tips,Poco C51 fix android problems,Poco C51 android issues,android help,Poco C51 android fix,android solutions,android guide,Poco C51 android guide,android support,Poco C51 android problems,fix android problems,android tips
...
<!-- affiliate ads end -->
## Calls on Poco C51 Go Straight to Voicemail? 12 Fixes
...
If a phone **call went straight to voicemail**, another possible explanation is the call barring. It is a feature that restricts calls from being made or received on your phone. If activated, it can cause incoming calls to a phone to go straight to voicemail. To turn off call barring on Poco C51 devices:
...
- **Step 1:** Open the **Google One** app on your Poco C51.
...
Dr.Fone supports over 1000 Android models, including unlocked Poco C51 models and models from carriers like [<u>AT&amp;T</u>](https://drfone.wondershare.com/sim-unlock/how-to-unlock-att-iphone.html) and Vodafone. It has an intuitive interface and is easy to use, even for beginners. Learn below the steps on how to use Dr.Fone System Repair to fix incoming calls that **dial straight to voicemail**:
...
- **Step 3:** Select **Android** as the Poco C51 device type.
...
- **Step 5:** Select the Poco C51 device details on the **Name**, **Model**, **Country**, and **Carrier** drop-down lists. Next, select the agreement checkbox, then click **Next** to proceed.

![choose device information to repair](https://images.wondershare.com/drfone/guide/android-system-repair-2.png)

- **Step 6:** Follow the in-app instructions to enter Download mode on your Poco C51, then click **Next**.
...
- **Step 8:** Enter the code in the input box to verify the Poco C51 device information in the dialogue box, then click **Confirm**.
...
- **Step 9:** The app will start repairing the system issue on your Poco C51. Once completed, your app should restart, then click **Done** to close the app.
...
## Fix Unfortunately Settings Has Stopped on Poco C51 Quickly

All of you, sooner or later, must have found the “Unfortunately Settings has stopped” error on your Poco C51. The problem can occur if the Settings keeps stopping or crashing. Many times, you may try to open the Settings but it doesn’t even open. Or possibly, it may freeze after getting opened thereby hampering the Poco C51 device's performance.
...
1. Open “Settings” on your Poco C51 and choose “Apps & Notifications”/”Apps”/”Application Manager” (the option may differ on different devices).
...
Using a custom ROM on your device brings up this problem due to incompatibility or improper installation. Therefore, you should either uninstall the custom ROM or re-flash the stock ROM. in order to re-flash the stock ROM of your Poco C51, the best way would be Dr.Fone - System Repair (Android). It offers one-click functionality to flash stock ROM and that too with full security. Supporting all Poco C51 devices, it ranks among its counterparts when it comes to fixing crashing Phone app issues or any other Android system issue. It is loaded with the beneficial features which are discussed below.
...
With the help of a USB cable, plug your Poco C51 into the PC. Upon proper connection, hit on the “Android Repair” option from the left panel.
...
Once the firmware is completely downloaded, your Poco C51 will automatically start getting repaired. Stay there and you will receive a notification that the repair is done.
...
5. Once finished, click the reboot option and the Poco C51 device will be rebooted, fixing the issue hopefully.
...
If your Poco C51 shows the "Unfortunately Settings has stopped" error, don't worry. This problem can come from many things like old software or cache issues. You can try easy fixes like clearing cache or updating your system. Sometimes, removing custom ROMs might be needed.
