---
title: Troubleshooting Guide How to Fix an Unresponsive Lava Yuva 2 Pro Screen | Dr.fone
date: 2024-07-30T11:57:04.348Z
updated: 2024-07-31T11:57:04.348Z
tags: 
  - problems
categories:
  - android
description: This article describes Troubleshooting Guide How to Fix an Unresponsive Lava Yuva 2 Pro Screen
excerpt: This article describes Troubleshooting Guide How to Fix an Unresponsive Lava Yuva 2 Pro Screen
keywords: android issues,android help,android tips,android guide,Lava Yuva 2 Pro android support,android repair
...
<!-- affiliate ads end -->
## How to Quickly Fix Bluetooth Not Working on Lava Yuva 2 Pro
...
Of course, the most common problem to occur with Bluetooth technology in your Lava Yuva 2 Pro is when it doesn’t connect to the Lava Yuva 2 Pro device you’re trying to link it to. This could be anything from a Bluetooth headset or headphones, to a portable speaker or even an in-car audio system.
...
**Step Two** Connect your Lava Yuva 2 Pro to your computer using the USB cable, wait a couple of seconds, and then click the System Repair option. On the Menu on the left, click Android Repair, and then press Start.
...
When the repair process has been completed, you’ll receive the screen below, which means you can try again if the process didn’t work, or you can disconnect your Lava Yuva 2 Pro and start using it and your Bluetooth features.
...
1. Turn your Lava Yuva 2 Pro off by holding down the Power button
...
Every service on your Lava Yuva 2 Pro using a feature called a cache. This is where information is stored to help the feature run properly and give you the best experience. However, over time this can get messy and can cause problems with your Bluetooth feature.
...
Sometimes, you may have a problem with the Lava Yuva 2 Pro device you’re trying to connect to via Bluetooth, especially if this is a device you’ve updated. To counter and repair this, you’re going to need to remove the paired devices saved with your device and then reconnect them.

Here’s how;

1. From the Main Menu of your Lava Yuva 2 Pro, head to Settings > Bluetooth > Connected Devices.
2. Turn Bluetooth on, and you’ll see all the connections your Lava Yuva 2 Pro is paired with
3. Go through these settings and remove/delete/forget every connection on your device
4. Now when you go to connect to a device using Bluetooth, repair the Lava Yuva 2 Pro device, enter the passcode, and use a fresh paired connection.
...
If you’re having problems with your connection and paired devices, sometimes you may have conflicting software faults in your device that are causing the problems. If this is the case, you’ll need to boot your Lava Yuva 2 Pro in Safe Mode.
...
4. Turn your Bluetooth feature on and connect to the Lava Yuva 2 Pro device you’re trying to connect too
...
Sometimes, you might not even have a problem with your Lava Yuva 2 Pro, but rather the Bluetooth device you’re trying to connect to, whether that’s a Bluetooth speaker, an in-car entertainment system, or any other kind of Bluetooth device.
...
1. Disconnect your Lava Yuva 2 Pro from the Bluetooth device and turn your Bluetooth off
2. Now take another Bluetooth device and connect this to the Lava Yuva 2 Pro device you’re trying to connect too. This could be another Android device, or even a computer or iOS device
3. If the new device doesn’t connect to your Bluetooth device, you’ll know there’s a problem with your Bluetooth device, not your Lava Yuva 2 Pro
4. If the Lava Yuva 2 Pro devices connect, you’ll know there’s a problem with your Lava Yuva 2 Pro
...
The further away the Lava Yuva 2 Pro devices are from each other, the less likely the connection will remain secure. As a rule of thumb, Bluetooth can work up to 100 meters, but to play it safe, always try and keep your devices under 50m apart.
