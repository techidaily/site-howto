---
title: Google Play Services Wont Update? 12 Fixes are Here on Infinix Smart 7 | Dr.fone
date: 2024-03-19 21:47:38
updated: 2024-03-21 21:21:49
tags: 
  - problems
categories:
  - android
description: This article describes Google Play Services Wont Update? 12 Fixes are Here on Infinix Smart 7
excerpt: This article describes Google Play Services Wont Update? 12 Fixes are Here on Infinix Smart 7
keywords: android problems,Infinix Smart 7 android troubleshooting,android repair,Infinix Smart 7 android fix,fix android problems,android fix,Infinix Smart 7 android problems
thumbnail: https://www.lifewire.com/thmb/TtsVrd32qSZ-IgZ8x0AB3dHyQVs=/400x300/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/how-to-make-a-song-your-ringtone-on-android-4777573-5d571b57c5a5436e91ebb7fcae1c2b6b.jpg
---

## Google Play Services Won't Update? 12 Fixes are Here on Infinix Smart 7
...
- **1\. Incompatibility with Custom ROMs:** Using a custom ROM on your Infinix Smart 7 can cause compatibility issues and prevent the installation of Google Play Services updates.
...
Now, taking the assistance of an original USB cable, connect your Infinix Smart 7 to the PC. Then hit on “Start”.
...
In most cases, restarting the Infinix Smart 7 device can simply do the trick. When you restart the Infinix Smart 7 device, most of the issues get eliminated making the Infinix Smart 7 device perform better than before. Also, it is all about RAM. While you restart your device, the RAM gets cleared. As a result, the apps work properly. So, in the first place, we would like you to restart your Infinix Smart 7 when you cannot update Google Play Services. Once restarted, try to update again and see if the results are positive.
...
If unfortunately, things are still the same, we would like to recommend you wipe the cache of the whole device to fix the issue. This is an advanced method to solve issues and is helpful when the Infinix Smart 7 device is facing any flaws or malfunctions. For this, you need to go to the download mode or recovery mode of your device. Every device has its own steps for this. Like in some, you need to simultaneously press the “Power” and “Volume Down” keys. While in some, the “Power” and both “Volume” keys work.
...
- Turn off the Infinix Smart 7 device to begin with and then follow the steps for recovery mode.
- On the recovery screen, use the “Volume” buttons for scrolling up and down and go to “Wipe cache partition”.
- To confirm, press the “Power” button. Now, the Infinix Smart 7 device will begin to wipe the cache.
- Hit reboot when asked and the Infinix Smart 7 device will now be rebooted finishing the issue.
...
Some devices aggressively optimize battery usage, which can interfere with the background processes required for updating Google Play Services. Disable battery optimization for Google Play Services in the Infinix Smart 7 device's Settings to ensure uninterrupted updates.
...
As a final measure, if everything went in vain, you can perform a factory reset on your device. This method will wipe away all your data while performing and make the Infinix Smart 7 device go to factory state. Please ensure to keep backing up your important data if you are going to take the help of this method.
...
To check the version of Google Play Services on your Infinix Smart 7, follow these steps:
