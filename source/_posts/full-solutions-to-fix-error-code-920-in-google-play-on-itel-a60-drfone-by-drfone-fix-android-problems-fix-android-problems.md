---
title: Full Solutions to Fix Error Code 920 In Google Play on Itel A60 | Dr.fone
date: 2024-06-20T01:05:44.698Z
updated: 2024-06-21T01:05:44.698Z
tags: 
  - problems
categories:
  - android
description: This article describes Full Solutions to Fix Error Code 920 In Google Play on Itel A60
excerpt: This article describes Full Solutions to Fix Error Code 920 In Google Play on Itel A60
keywords: Itel A60 android solutions,android repair,android issues,Itel A60 android help,android problems,Itel A60 android tips,android help,Itel A60 fix android problems
thumbnail: https://thmb.techidaily.com/502b1cdc938497dc65859bd4dea7388cbc83b5388aae8627911832c708fd7626.jpg
---

## Full Solutions to Fix Error Code 920 In Google Play on Itel A60
...
- Supports various Itel A60 devices, including the latest Itel A60 S9/S8
...
Then connect your Itel A60 using the official cable and select the ‘Android Repair’ option.
...
1\. Download and install the software on your PC. Run the software and then select the **Data Recovery** feature. Using a USB, connect your Itel A60 to the PC.
...
## Part 3: Restart your Itel A60

Once you have successfully retrieved your data, consider solving the Android crash issue as soon as possible. Before you redirect to a proper solution for repairing your Itel A60 system, you can try restarting your device as a quick remedy. Restart the Android device to clear temporary system data and potentially resolve any software glitches causing the crash, which can be done as follows:

**Instructions:** Hold your Itel A60's "Power" button on the side of the phone. As the following window appears on the screen, select the "Reboot" option to restart the Android device successfully.
...
Another quick solution to avoid Android devices crashing is to shut down unnecessary apps running in the Itel A60 device's background. To cater to that, you need to try out the following steps as a remedy to shutting down unwanted applications:

**Step 1:** Open the “Settings” of your Itel A60 and continue to the “Battery and device care” section from the available options. Continue to the "Memory" section on the next window to lead to the applications taking up space on your Itel A60.
...
If you are constantly facing issues of your Itel A60 crashing, there is a possibility that your device's storage is full. The need to free up space arouses the need to know about the potential steps for checking storage and cleaning up space, which is discussed as follows:
...
1\. On your Itel A60, visit “Settings” and find “Storage”
...
1\. Firstly, eject it from the Itel A60 device.
...
- Features support for all the latest Android devices up to Itel A60 S22.
...
After selecting the nature of the Itel A60 device you want to repair, navigate to a new window where you need to click "Start" to initiate the system repair process.
...
Whatsoever Android you own, you need to put it in Download Mode, depending on the buttons that the Itel A60 device has. The repairing process initiates as you enter the Download Mode, and new firmware is downloaded on the platform.
...
## Part 11: Factory reset the Itel A60 device to fix the Android crash issue
...
The process of factory resetting your Itel A60 is risky and cumbersome, as it deleted all data, but it helps to fix the Android System crash error.
