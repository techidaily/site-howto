---
title: My Videos Arent Playing on Huawei P60 – What Can I Do? | Dr.fone
...
categories:
  - android
description: This article describes My Videos Arent Playing on Huawei P60 – What Can I Do?
excerpt: This article describes My Videos Arent Playing on Huawei P60 – What Can I Do?
keywords: android problems,fix android problems,Huawei P60 android support,android support,android repair,Huawei P60 android solutions
...
## How to Fix Android.Process.Media Has Stopped on Huawei P60
...
Then connect your Huawei P60 to the computer and make sure that it can be recognized by your computer. Then click on "My Backup" on Dr.Fone.
...
With a full backup of your Huawei P60, you can now embark on a mission to fix the error. There are several methods to clear this error. We have outlined three of the most effective solutions here.
...
Step 6: Turn off the Huawei P60 device and then turn it back on. Go to the Google Services framework again and turn it on to see if the issue has been resolved.
...
Then connect your Huawei P60 with the correct cable and choose "Android" > click "Start".
...
In the Huawei P60 device information interface, remember to select the correct information. Then confirm the warning and click "Next".
...
**Step 2. Repair your Huawei P60 in Download mode.**

Read and follow the [guide here](https://drfone.wondershare.com/guide/android-repair.html) to boot your Huawei P60 in Download mode.
...
If the above steps fail, you might need to perform a factory reset. A factory reset restores the Huawei P60 device to its initial state, which can eliminate many problems, but it will also erase all data. Ensure you back up your important data before proceeding.
