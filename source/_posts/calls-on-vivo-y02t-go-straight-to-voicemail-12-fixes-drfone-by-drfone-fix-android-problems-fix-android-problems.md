---
title: Calls on Vivo Y02T Go Straight to Voicemail? 12 Fixes | Dr.fone
date: 2024-07-30T09:57:03.053Z
updated: 2024-07-31T09:57:03.053Z
tags: 
  - problems
categories:
  - android
description: This article describes Calls on Vivo Y02T Go Straight to Voicemail? 12 Fixes
excerpt: This article describes Calls on Vivo Y02T Go Straight to Voicemail? 12 Fixes
keywords: Vivo Y02T android fix,Vivo Y02T android problems,Vivo Y02T android solutions,android troubleshooting,Vivo Y02T fix android problems,android issues,Vivo Y02T android issues,android tips,Vivo Y02T android guide,android support
thumbnail: https://thmb.techidaily.com/ac86b0aa564fee722115c20830e542db073002bfbdd584be2acd66419238b8a6.png
---

## Calls on Vivo Y02T Go Straight to Voicemail? 12 Fixes
...
If a phone **call went straight to voicemail**, another possible explanation is the call barring. It is a feature that restricts calls from being made or received on your phone. If activated, it can cause incoming calls to a phone to go straight to voicemail. To turn off call barring on Vivo Y02T devices:
...
- **Step 1:** Open the **Google One** app on your Vivo Y02T.
...
Dr.Fone supports over 1000 Android models, including unlocked Vivo Y02T models and models from carriers like [<u>AT&amp;T</u>](https://drfone.wondershare.com/sim-unlock/how-to-unlock-att-iphone.html) and Vodafone. It has an intuitive interface and is easy to use, even for beginners. Learn below the steps on how to use Dr.Fone System Repair to fix incoming calls that **dial straight to voicemail**:
...
- **Step 3:** Select **Android** as the Vivo Y02T device type.
...
- **Step 5:** Select the Vivo Y02T device details on the **Name**, **Model**, **Country**, and **Carrier** drop-down lists. Next, select the agreement checkbox, then click **Next** to proceed.

![choose device information to repair](https://images.wondershare.com/drfone/guide/android-system-repair-2.png)

- **Step 6:** Follow the in-app instructions to enter Download mode on your Vivo Y02T, then click **Next**.
...
- **Step 8:** Enter the code in the input box to verify the Vivo Y02T device information in the dialogue box, then click **Confirm**.

![confirm device information](https://images.wondershare.com/drfone/guide/android-system-repair-7.png)

- **Step 9:** The app will start repairing the system issue on your Vivo Y02T. Once completed, your app should restart, then click **Done** to close the app.
...
## Google Play Services Won't Update? 12 Fixes are Here on Vivo Y02T
...
- **1\. Incompatibility with Custom ROMs:** Using a custom ROM on your Vivo Y02T can cause compatibility issues and prevent the installation of Google Play Services updates.
...
Now, taking the assistance of an original USB cable, connect your Vivo Y02T to the PC. Then hit on “Start”.
...
In most cases, restarting the Vivo Y02T device can simply do the trick. When you restart the Vivo Y02T device, most of the issues get eliminated making the Vivo Y02T device perform better than before. Also, it is all about RAM. While you restart your device, the RAM gets cleared. As a result, the apps work properly. So, in the first place, we would like you to restart your Vivo Y02T when you cannot update Google Play Services. Once restarted, try to update again and see if the results are positive.
...
If unfortunately, things are still the same, we would like to recommend you wipe the cache of the whole device to fix the issue. This is an advanced method to solve issues and is helpful when the Vivo Y02T device is facing any flaws or malfunctions. For this, you need to go to the download mode or recovery mode of your device. Every device has its own steps for this. Like in some, you need to simultaneously press the “Power” and “Volume Down” keys. While in some, the “Power” and both “Volume” keys work.
...
- Turn off the Vivo Y02T device to begin with and then follow the steps for recovery mode.
- On the recovery screen, use the “Volume” buttons for scrolling up and down and go to “Wipe cache partition”.
- To confirm, press the “Power” button. Now, the Vivo Y02T device will begin to wipe the cache.
- Hit reboot when asked and the Vivo Y02T device will now be rebooted finishing the issue.
...
Some devices aggressively optimize battery usage, which can interfere with the background processes required for updating Google Play Services. Disable battery optimization for Google Play Services in the Vivo Y02T device's Settings to ensure uninterrupted updates.
...
As a final measure, if everything went in vain, you can perform a factory reset on your device. This method will wipe away all your data while performing and make the Vivo Y02T device go to factory state. Please ensure to keep backing up your important data if you are going to take the help of this method.
...
To check the version of Google Play Services on your Vivo Y02T, follow these steps:
