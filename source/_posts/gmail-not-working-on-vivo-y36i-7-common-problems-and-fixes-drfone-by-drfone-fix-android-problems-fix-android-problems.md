---
title: Gmail Not Working on Vivo Y36i 7 Common Problems & Fixes | Dr.fone
date: 2024-07-30T11:19:55.826Z
updated: 2024-07-31T11:19:55.826Z
tags: 
  - problems
categories:
  - android
description: This article describes Gmail Not Working on Vivo Y36i 7 Common Problems & Fixes
excerpt: This article describes Gmail Not Working on Vivo Y36i 7 Common Problems & Fixes
keywords: Vivo Y36i android tips,android help,Vivo Y36i android solutions,android fix,Vivo Y36i android fix,fix android problems,android guide,Vivo Y36i android problems
...
Authentication error occurs when the “deal” between the Wi-Fi router and device fails due to certain reasons. First, the Vivo Y36i device sends the password of the network and the "connect" request in an encrypted format to the Wi-Fi router. Then, the router decrypts the password and compares the password saved on it. Now, if the password matches, it sends affirmation for the "connect" request, and then the Vivo Y36i device is allowed to connect to the network.
...
1. Connect your Vivo Y36i to the computer, and select "Android Repair" in the middle.
...
1. Next up, you should boot your Vivo Y36i in download mode by following the on-screen instructions.
...
Step 1: Head to the “Settings” of your Vivo Y36i and then opt for “Wireless and Networks” followed by “WLAN/WiFi”.

Step 2: Now, hit on the WiFi network that is showing "authentication error occurred".

Step 3: Depending on your Vivo Y36i model, look for “IP Settings” and tap on it. Now, switch the “DHCP” to “Static”.
...
There are instances where an outdated OS version of your Vivo Y36i may create a hindrance in establishing a connection between your device and the WiFi network. You need to update your Android firmware to the latest version and then check if the problem persists or not.

Step 1: Launch “Settings” of your Vivo Y36i and then get into the “About Phone” option.
