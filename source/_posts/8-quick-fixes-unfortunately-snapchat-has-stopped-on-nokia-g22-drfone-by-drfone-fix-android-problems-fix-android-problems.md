---
title: 8 Quick Fixes Unfortunately, Snapchat has Stopped on Nokia G22 | Dr.fone
date: 2024-05-20T09:03:28.006Z
updated: 2024-05-21T09:03:28.006Z
tags: 
  - problems
categories:
  - android
description: This article describes 8 Quick Fixes Unfortunately, Snapchat has Stopped on Nokia G22
excerpt: This article describes 8 Quick Fixes Unfortunately, Snapchat has Stopped on Nokia G22
keywords: Nokia G22 android solutions,Nokia G22 android guide,android guide,Nokia G22 android help,android troubleshooting,android problems,Nokia G22 android problems,Nokia G22 fix android problems,Nokia G22 android repair
thumbnail: https://www.lifewire.com/thmb/EAqZr-HjkZo5i0jwoEEUqZxRCpc=/400x300/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/GettyImages-1437209125-b47ae60035f248e2b01b781f50f919c1.jpg
---

## [8 Quick Fixes] Unfortunately, Snapchat has Stopped on Nokia G22
...
- Can fully repair faults with your Nokia G22’s firmware in a few simple steps.
...
**Step 2**: From the main menu, click the System Repair option, followed by the **Android** option. Of course, if you have an iOS device you want to repair in the future, the option is there if you want it. Also, connect your Nokia G22 to your computer using the USB cable.
...
**Step 5:** Once in Download Mode, the software will now download and install a fresh version of your Nokia G22’s operating system. This can take some time, so make sure your device stays connected, and your computer stays on and doesn’t shut down.
...
**Step 1:** Open the Settings menu on your Nokia G22 and select the About Phone option.
...
**Step 1:** Open the Settings menu on your Nokia G22, followed by the Wi-Fi option.
...
Unfortunately, there’s no easy fix to this, and if you want to continue using the app, you’ll need to reflash your Nokia G22 back to its original firmware, and then wait until the ROM developers update the ROM to be compatible with social apps like Snapchat.
...
2. Connect your Nokia G22 to your Windows computer using the USB cable
...
7. Allow the software to repair your Nokia G22 automatically
...
One of the last resorts you can take is factory resetting your Nokia G22 back to its original settings. From the day you first started using your device, you’ve been using the system and downloading files and apps, and over time this increases the chances of creating a bug.
...
## 7 Solutions to Fix Error Code 963 on Google Play Of Nokia G22
...
**Note:** _Before moving to solve the error 963, we would like to inform you that the process may result in wiping away your data. And therefore, we suggest you to [make backup of your Nokia G22](https://tools.techidaily.com/wondershare/drfone/android-backup-and-restore/) prior to fixing this Google Play error 963__._

**Phase 1: Connecting and preparing the Nokia G22 device**

Step 1 – To begin fixing error 963, run Dr.Fone after downloading and installing it on your PC. Now, pick out the ‘System Repair’ tab from the main screen. Thereupon, with the help of a USB cable, make connection between your Nokia G22 and PC
...
Step 1 – It is essential to get your Nokia G22 or tablet entered in Download mode. For this, following are the steps to be taken:

If the Nokia G22 device contains Home button:

- Turn the Nokia G22 device off and then keep holding the ‘Power’, ‘Volume Down’ and ‘Home’ buttons altogether for about 10 seconds. Next, release them all and push the ‘Volume Up’ key. This way, your device will enter the Download mode.

![fix google play error 963 on android with home key](https://images.wondershare.com/drfone/guide/android-system-repair-3.png)

If the Nokia G22 device contains no Home button:
...
This method is strictly for certain Apps which cannot be updated because they are stored on an external memory card, i.e., SD Card. Such memory enhancing chips do not support large Apps and due to a shortage of space prevents them from updating. It advisable to move such Apps from the SD Card to the Nokia G22 device’s internal memory and then try to update it.
