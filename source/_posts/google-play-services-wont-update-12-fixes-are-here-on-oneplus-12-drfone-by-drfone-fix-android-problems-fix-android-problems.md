---
title: Google Play Services Wont Update? 12 Fixes are Here on OnePlus 12 | Dr.fone
date: 2024-07-30T11:24:01.835Z
updated: 2024-07-31T11:24:01.835Z
tags: 
  - problems
categories:
  - android
description: This article describes Google Play Services Wont Update? 12 Fixes are Here on OnePlus 12
excerpt: This article describes Google Play Services Wont Update? 12 Fixes are Here on OnePlus 12
keywords: OnePlus 12 android issues,OnePlus 12 android support,android help,OnePlus 12 android tips,OnePlus 12 android repair,android repair,android support,android tips,android fix,OnePlus 12 android problems,OnePlus 12 android troubleshooting
thumbnail: https://thmb.techidaily.com/3c9a0c6a221fee25e096fdddf37ef07f9a19a2323a0faabfa25ea26bfdcf4c13.jpg
---

## Google Play Services Won't Update? 12 Fixes are Here on OnePlus 12
...
- **1\. Incompatibility with Custom ROMs:** Using a custom ROM on your OnePlus 12 can cause compatibility issues and prevent the installation of Google Play Services updates.
...
Now, taking the assistance of an original USB cable, connect your OnePlus 12 to the PC. Then hit on “Start”.
...
In most cases, restarting the OnePlus 12 device can simply do the trick. When you restart the OnePlus 12 device, most of the issues get eliminated making the OnePlus 12 device perform better than before. Also, it is all about RAM. While you restart your device, the RAM gets cleared. As a result, the apps work properly. So, in the first place, we would like you to restart your OnePlus 12 when you cannot update Google Play Services. Once restarted, try to update again and see if the results are positive.
...
If unfortunately, things are still the same, we would like to recommend you wipe the cache of the whole device to fix the issue. This is an advanced method to solve issues and is helpful when the OnePlus 12 device is facing any flaws or malfunctions. For this, you need to go to the download mode or recovery mode of your device. Every device has its own steps for this. Like in some, you need to simultaneously press the “Power” and “Volume Down” keys. While in some, the “Power” and both “Volume” keys work.
...
- Turn off the OnePlus 12 device to begin with and then follow the steps for recovery mode.
- On the recovery screen, use the “Volume” buttons for scrolling up and down and go to “Wipe cache partition”.
- To confirm, press the “Power” button. Now, the OnePlus 12 device will begin to wipe the cache.
- Hit reboot when asked and the OnePlus 12 device will now be rebooted finishing the issue.
...
Some devices aggressively optimize battery usage, which can interfere with the background processes required for updating Google Play Services. Disable battery optimization for Google Play Services in the OnePlus 12 device's Settings to ensure uninterrupted updates.
...
As a final measure, if everything went in vain, you can perform a factory reset on your device. This method will wipe away all your data while performing and make the OnePlus 12 device go to factory state. Please ensure to keep backing up your important data if you are going to take the help of this method.
...
To check the version of Google Play Services on your OnePlus 12, follow these steps:
...
<!-- affiliate ads end -->
## Stuck at Android System Recovery Of OnePlus 12 ? Fix It Easily
...
Now that you know how useful the Android System can be, you may want to know how to utilize this feature to get out of some of the problems we mentioned above. Here's how you can safely get to the Android recovery system on your OnePlus 12.

Step 1: Hold down the power key and then select "Power Off" from the options on the screen. If, however, your screen is unresponsive, keep holding the power key for several seconds until the OnePlus 12 device is completely turned off.
...
- Supports all latest OnePlus 12 devices
...
**Note:** _Be aware that this process can erase all your personal files on your device, so ensure you've [backed up your OnePlus 12](https://tools.techidaily.com/wondershare/drfone/android-backup-and-restore/) before continuing._

**Step #1** Head over to the Dr.Fone website and download the software for your Windows computer.

Once installed on your computer, open onto the main menu and connect your OnePlus 12 using the official USB cable. Select the System Repair option.
...
Step 1: Power off the OnePlus 12 device, and just to be sure, take out the battery to ensure that the OnePlus 12 device is fully turned off. Then reinsert the battery.

Step 2: Press and hold down the Home button, Power Button, and the Volume up Key simultaneously until the OnePlus 12 device vibrates.
...
Losing data on your OnePlus 12 is a common occurrence, and since Android devices don't really have an automatic full backup solution, it is important to know how to backup and restore your device system. Here's how to easily do that.

Step 1: Enter the recovery mode on your OnePlus 12, as described in Part 2 above. Use the Volume and Power keys to select the "Backup & Restore" option on the screen.
...
Step 3: After the process is complete, choose "Reboot" to restart the OnePlus 12 device.
