---
title: 4 Solutions to Fix Unfortunately Your App Has Stopped Error on Nokia 105 Classic | Dr.fone
date: 2024-07-30T07:22:58.444Z
updated: 2024-07-31T07:22:58.444Z
tags: 
  - problems
categories:
  - android
description: This article describes 4 Solutions to Fix Unfortunately Your App Has Stopped Error on Nokia 105 Classic
excerpt: This article describes 4 Solutions to Fix Unfortunately Your App Has Stopped Error on Nokia 105 Classic
keywords: android problems,Nokia 105 Classic android troubleshooting,Nokia 105 Classic android support,Nokia 105 Classic android issues,android tips,android help,android issues,android fix,Nokia 105 Classic android fix,fix android problems,Nokia 105 Classic android tips,android solutions
...
Authentication error occurs when the “deal” between the Wi-Fi router and device fails due to certain reasons. First, the Nokia 105 Classic device sends the password of the network and the "connect" request in an encrypted format to the Wi-Fi router. Then, the router decrypts the password and compares the password saved on it. Now, if the password matches, it sends affirmation for the "connect" request, and then the Nokia 105 Classic device is allowed to connect to the network.
...
1. Connect your Nokia 105 Classic to the computer, and select "Android Repair" in the middle.
...
1. Next up, you should boot your Nokia 105 Classic in download mode by following the on-screen instructions.
...
Step 1: Head to the “Settings” of your Nokia 105 Classic and then opt for “Wireless and Networks” followed by “WLAN/WiFi”.

Step 2: Now, hit on the WiFi network that is showing "authentication error occurred".

Step 3: Depending on your Nokia 105 Classic model, look for “IP Settings” and tap on it. Now, switch the “DHCP” to “Static”.
...
There are instances where an outdated OS version of your Nokia 105 Classic may create a hindrance in establishing a connection between your device and the WiFi network. You need to update your Android firmware to the latest version and then check if the problem persists or not.

Step 1: Launch “Settings” of your Nokia 105 Classic and then get into the “About Phone” option.
