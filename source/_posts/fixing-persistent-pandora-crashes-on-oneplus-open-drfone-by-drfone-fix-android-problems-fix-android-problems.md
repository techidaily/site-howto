---
title: Fixing Persistent Pandora Crashes on OnePlus Open | Dr.fone
date: 2024-07-30T10:53:54.461Z
updated: 2024-07-31T10:53:54.461Z
tags: 
  - problems
categories:
  - android
description: This article describes Fixing Persistent Pandora Crashes on OnePlus Open
excerpt: This article describes Fixing Persistent Pandora Crashes on OnePlus Open
keywords: android help,OnePlus Open android tips,OnePlus Open android solutions,OnePlus Open android help,android tips,OnePlus Open android issues,android fix,android solutions,OnePlus Open android fix,OnePlus Open android guide,OnePlus Open fix android problems,OnePlus Open android support
...
Authentication error occurs when the “deal” between the Wi-Fi router and device fails due to certain reasons. First, the OnePlus Open device sends the password of the network and the "connect" request in an encrypted format to the Wi-Fi router. Then, the router decrypts the password and compares the password saved on it. Now, if the password matches, it sends affirmation for the "connect" request, and then the OnePlus Open device is allowed to connect to the network.
...
- Supports all the new OnePlus Open devices like Galaxy S8, S9, etc.
...
1. Connect your OnePlus Open to the computer, and select "Android Repair" in the middle.
...
1. Next up, you should boot your OnePlus Open in download mode by following the on-screen instructions.
...
Step 1: Head to the “Settings” of your OnePlus Open and then opt for “Wireless and Networks” followed by “WLAN/WiFi”.

Step 2: Now, hit on the WiFi network that is showing "authentication error occurred".

Step 3: Depending on your OnePlus Open model, look for “IP Settings” and tap on it. Now, switch the “DHCP” to “Static”.
...
There are instances where an outdated OS version of your OnePlus Open may create a hindrance in establishing a connection between your device and the WiFi network. You need to update your Android firmware to the latest version and then check if the problem persists or not.

Step 1: Launch “Settings” of your OnePlus Open and then get into the “About Phone” option.
