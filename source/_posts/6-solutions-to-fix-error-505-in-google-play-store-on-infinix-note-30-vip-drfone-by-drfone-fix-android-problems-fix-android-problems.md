---
title: 6 Solutions to Fix Error 505 in Google Play Store on Infinix Note 30 VIP | Dr.fone
date: 2024-05-20T09:03:24.590Z
updated: 2024-05-21T09:03:24.590Z
tags: 
  - problems
categories:
  - android
description: This article describes 6 Solutions to Fix Error 505 in Google Play Store on Infinix Note 30 VIP
excerpt: This article describes 6 Solutions to Fix Error 505 in Google Play Store on Infinix Note 30 VIP
keywords: android guide,Infinix Note 30 VIP android guide,Infinix Note 30 VIP android repair,Infinix Note 30 VIP android tips,android tips,android repair,Infinix Note 30 VIP android troubleshooting
thumbnail: https://www.lifewire.com/thmb/KrjxcoVkV9vT3cQ3C-URm7mlpcM=/400x300/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/GettyImages-917461864-7141ebd3ec944ce6a431b8d485cc9cdb.jpg
---

## 6 Solutions to Fix Error 505 in Google Play Store on Infinix Note 30 VIP
...
Step5: After the Infinix Note 30 VIP device firmware is downloaded, the tool will start repairing your Android.
...
\>Select the Application Manger or App (Option depends upon the Infinix Note 30 VIP device)

At the top, an option will appear

\>Swipe right till you locate Download manager at top of the screen of the Infinix Note 30 VIP device

\>Then Select Enable

![Application Manger](https://images.wondershare.com/drfone/article/2017/06/14976274734570.jpg)

Enabling download manager to give permission to the Infinix Note 30 VIP device to start the download or installation process.

#### **Solution 3: Updating to the latest version of OS of your Infinix Note 30 VIP**
...
## 4 Ways to Fix Android Blue Screen of Death On Infinix Note 30 VIP
...
## Part 1: How to rescue data on Infinix Note 30 VIP with blue screen of death?

The Android blue screen of death issue is not a difficult problem to deal with and can be fixed by you by following the easy steps given in this article. We suggest that all readers rescue the data stored on their Android devices to prevent data loss and keep it stored in your PC from where it can be accessed and recovered by you anytime, anywhere. This task might sound tedious, but, we have for you [Dr.Fone - Data Recovery (Android)](https://drfone.wondershare.com/android-data-recovery.html), a software specially designed to retrieve data from broken and damaged Infinix Note 30 VIP phones and tabs, especially Infinix Note 30 VIP devices, and keep it safe in your PC without tampering with it or altering its format. It efficiently extracts data from broken or unresponsive Infinix Note 30 VIP devices, phones/tabs stuck at black/blue screen, or whose system crashed due to a virus attack.
...
6\. In this step, refer to the instructions in your device manual to enter into Download Mode on your Infinix Note 30 VIP and hit “Next”. An example of what to do to reach Download Mode is shown below.
...
7\. Finally, let the software recognize your Infinix Note 30 VIP, and start to download the recovery package for your device.
...
This software effectively fixes Android screen of death issue along with app crashing, bricked or unresponsive device, stuck on Infinix Note 30 VIP logo, etc. All Android issues are well taken care of by Dr.Fone - System Repair (Android) with one click.
...
- All the latest Infinix Note 30 VIP devices are supported by this program.
...
Step 3: Over the Infinix Note 30 VIP device information window, select all relevant data about your device followed by the ‘Next’ button.
...
Step 1: Get the Infinix Note 30 VIP device in ‘Download’ mode to fix the **Android blue screen of death** issue. Here is how –

- On a ‘Home’ button-less device – you need to switch off the Infinix Note 30 VIP device. Now, hold the ‘Volume Down’, ‘Power’, and ‘Bixby’ keys together for about 10 seconds and release. Hit the ‘Volume Up’ key to get into ‘Download’ mode.
...
The best home remedy to fix any kind of Android screen of death remove the Infinix Note 30 VIP device’s battery. This technique might sound too simple, but it has solved the Android blue screen of death issue for many users whose devices started normally after reinserting the battery. Here is what you should do.

1\. Open the back cover of your Infinix Note 30 VIP and carefully remove its battery.
...
**Step:** Open the Settings app on your Infinix Note 30 VIP by locating and launching it. Proceed by scrolling through the options and selecting "Software Update." In the ensuing screen, choose "Download and Install" to start a search for any available updates.
...
Now use the power button to select it and wait for the Infinix Note 30 VIP device to reboot automatically.
...
Have you tried all the methods, and your Infinix Note 30 VIP is still stuck on the blue screen of death? In this case, it's important to consider the possibility of a hardware issue. Remember that hardware issues can be complex. Trying to fix things without the right expertise can result in additional harm. If you're uncertain about the next steps, it's wisest to ask for assistance from a trained professional.
...
## [8 Quick Fixes] Unfortunately, Snapchat has Stopped on Infinix Note 30 VIP
...
- Can fully repair faults with your Infinix Note 30 VIP’s firmware in a few simple steps.
...
**Step 2**: From the main menu, click the System Repair option, followed by the **Android** option. Of course, if you have an iOS device you want to repair in the future, the option is there if you want it. Also, connect your Infinix Note 30 VIP to your computer using the USB cable.
...
**Step 5:** Once in Download Mode, the software will now download and install a fresh version of your Infinix Note 30 VIP’s operating system. This can take some time, so make sure your device stays connected, and your computer stays on and doesn’t shut down.
...
**Step 1:** Open the Settings menu on your Infinix Note 30 VIP and select the About Phone option.
...
**Step 1:** Open the Settings menu on your Infinix Note 30 VIP, followed by the Wi-Fi option.
...
Unfortunately, there’s no easy fix to this, and if you want to continue using the app, you’ll need to reflash your Infinix Note 30 VIP back to its original firmware, and then wait until the ROM developers update the ROM to be compatible with social apps like Snapchat.
...
2. Connect your Infinix Note 30 VIP to your Windows computer using the USB cable
...
7. Allow the software to repair your Infinix Note 30 VIP automatically
...
One of the last resorts you can take is factory resetting your Infinix Note 30 VIP back to its original settings. From the day you first started using your device, you’ve been using the system and downloading files and apps, and over time this increases the chances of creating a bug.
