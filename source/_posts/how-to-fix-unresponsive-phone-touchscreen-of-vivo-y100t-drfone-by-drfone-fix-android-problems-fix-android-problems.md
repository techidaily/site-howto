---
title: How To Fix Unresponsive Phone Touchscreen Of Vivo Y100t | Dr.fone
date: 2024-03-20 15:23:57
updated: 2024-03-21 11:21:36
tags: 
  - problems
categories:
  - android
description: This article describes How To Fix Unresponsive Phone Touchscreen Of Vivo Y100t
excerpt: This article describes How To Fix Unresponsive Phone Touchscreen Of Vivo Y100t
keywords: android repair,Vivo Y100t fix android problems,Vivo Y100t android solutions,android fix,Vivo Y100t android issues,android guide,android help,Vivo Y100t android problems,fix android problems
...
## 8 Ultimate Fixes for Google Play Your Vivo Y100t Isn't Compatible
...
- **Step 1.** On your Vivo Y100t, find the Google Play Store and long-press its icon. Press "App info" from the pop-up menu to access the app information screen.
...
An outdated operating system is a common factor behind compatibility issues. This case is often used with Google Play Store and other important apps. Maintaining your Vivo Y100t's compatibility with the latest app releases is essential. To ensure your Android operating system is up-to-date, please proceed with the following steps:

**Instructions.** You will need to start by accessing the Vivo Y100t device's “Settings.” Scroll down to find and press the "System" option. On the following screen, tap "Software Update" to check if an update is available. If there is one, follow the on-screen prompts to update your device's OS.
...
- **Step 1.** Using your Vivo Y100t's Settings, access the Google Play Store app in the "Apps" tab. Once on its info page, tap the three dots icon from the top right corner.
...
1. Fone – System Repair (Android) allows you to repair your Vivo Y100t easily in just a few clicks.
...
After that, you need to enter the Vivo Y100t device details like the “Name, Model, Brand, etc.” and put your phone on a Download Mode. Following this step, the firmware will download on its own, and you need to click the “Fix Now” button to install it on your Vivo Y100t.
...
In the last step, you will have to put in the code and proceed with the “Confirm” button to initiate the repair process. This may delete all your data in the Vivo Y100t device, and once it has ended, select the “Done” button to conclude the process.
