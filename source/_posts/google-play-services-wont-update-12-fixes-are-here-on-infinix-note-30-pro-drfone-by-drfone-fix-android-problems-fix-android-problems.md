---
title: Google Play Services Wont Update? 12 Fixes are Here on Infinix Note 30 Pro | Dr.fone
date: 2024-07-30T11:22:20.130Z
updated: 2024-07-31T11:22:20.130Z
tags: 
  - problems
categories:
  - android
description: This article describes Google Play Services Wont Update? 12 Fixes are Here on Infinix Note 30 Pro
excerpt: This article describes Google Play Services Wont Update? 12 Fixes are Here on Infinix Note 30 Pro
keywords: android troubleshooting,Infinix Note 30 Pro android fix,Infinix Note 30 Pro android support,android help,android issues,Infinix Note 30 Pro android help,Infinix Note 30 Pro android issues,android repair
thumbnail: https://thmb.techidaily.com/4e54d2ee69e2d3cc5b62664f281e174d4bc506ec5c304888c5062a8c04d6107f.jpg
---

## Google Play Services Won't Update? 12 Fixes are Here on Infinix Note 30 Pro
...
- **1\. Incompatibility with Custom ROMs:** Using a custom ROM on your Infinix Note 30 Pro can cause compatibility issues and prevent the installation of Google Play Services updates.
...
Now, taking the assistance of an original USB cable, connect your Infinix Note 30 Pro to the PC. Then hit on “Start”.
...
In most cases, restarting the Infinix Note 30 Pro device can simply do the trick. When you restart the Infinix Note 30 Pro device, most of the issues get eliminated making the Infinix Note 30 Pro device perform better than before. Also, it is all about RAM. While you restart your device, the RAM gets cleared. As a result, the apps work properly. So, in the first place, we would like you to restart your Infinix Note 30 Pro when you cannot update Google Play Services. Once restarted, try to update again and see if the results are positive.
...
If unfortunately, things are still the same, we would like to recommend you wipe the cache of the whole device to fix the issue. This is an advanced method to solve issues and is helpful when the Infinix Note 30 Pro device is facing any flaws or malfunctions. For this, you need to go to the download mode or recovery mode of your device. Every device has its own steps for this. Like in some, you need to simultaneously press the “Power” and “Volume Down” keys. While in some, the “Power” and both “Volume” keys work.
...
- Turn off the Infinix Note 30 Pro device to begin with and then follow the steps for recovery mode.
- On the recovery screen, use the “Volume” buttons for scrolling up and down and go to “Wipe cache partition”.
- To confirm, press the “Power” button. Now, the Infinix Note 30 Pro device will begin to wipe the cache.
- Hit reboot when asked and the Infinix Note 30 Pro device will now be rebooted finishing the issue.
...
Some devices aggressively optimize battery usage, which can interfere with the background processes required for updating Google Play Services. Disable battery optimization for Google Play Services in the Infinix Note 30 Pro device's Settings to ensure uninterrupted updates.
...
As a final measure, if everything went in vain, you can perform a factory reset on your device. This method will wipe away all your data while performing and make the Infinix Note 30 Pro device go to factory state. Please ensure to keep backing up your important data if you are going to take the help of this method.
...
To check the version of Google Play Services on your Infinix Note 30 Pro, follow these steps:
...
1\. Download and install the software on your PC. Run the software and then select the **Data Recovery** feature. Using a USB, connect your Infinix Note 30 Pro to the PC.
...
<!-- affiliate ads end -->
## Part 3: Restart your Infinix Note 30 Pro

Once you have successfully retrieved your data, consider solving the Android crash issue as soon as possible. Before you redirect to a proper solution for repairing your Infinix Note 30 Pro system, you can try restarting your device as a quick remedy. Restart the Android device to clear temporary system data and potentially resolve any software glitches causing the crash, which can be done as follows:

**Instructions:** Hold your Infinix Note 30 Pro's "Power" button on the side of the phone. As the following window appears on the screen, select the "Reboot" option to restart the Android device successfully.
...
Another quick solution to avoid Android devices crashing is to shut down unnecessary apps running in the Infinix Note 30 Pro device's background. To cater to that, you need to try out the following steps as a remedy to shutting down unwanted applications:

**Step 1:** Open the “Settings” of your Infinix Note 30 Pro and continue to the “Battery and device care” section from the available options. Continue to the "Memory" section on the next window to lead to the applications taking up space on your Infinix Note 30 Pro.
...
If your Android system crash takes place frequently but the Infinix Note 30 Pro device turns on normally after that, there is a chance that some Apps may be causing the problem. Unnecessary and large App files burden the Infinix Note 30 Pro device system and force it to crash every now and then. Make sure you download, install and store only those Apps which are fully compatible with your Android system. DO NOT download Apps from other unknown sources and use only Google Play store for the purpose. All other incompatible Apps must be deleted to prevent them from tweaking your software.
...
If you are constantly facing issues of your Infinix Note 30 Pro crashing, there is a possibility that your device's storage is full. The need to free up space arouses the need to know about the potential steps for checking storage and cleaning up space, which is discussed as follows:
...
1\. On your Infinix Note 30 Pro, visit “Settings” and find “Storage”
...
1\. Firstly, eject it from the Infinix Note 30 Pro device.
...
- Features support for all the latest Android devices up to Infinix Note 30 Pro S22.
...
After selecting the nature of the Infinix Note 30 Pro device you want to repair, navigate to a new window where you need to click "Start" to initiate the system repair process.
...
Whatsoever Android you own, you need to put it in Download Mode, depending on the buttons that the Infinix Note 30 Pro device has. The repairing process initiates as you enter the Download Mode, and new firmware is downloaded on the platform.
...
<!-- affiliate ads end -->
## Part 11: Factory reset the Infinix Note 30 Pro device to fix the Android crash issue
...
The process of factory resetting your Infinix Note 30 Pro is risky and cumbersome, as it deleted all data, but it helps to fix the Android System crash error.
