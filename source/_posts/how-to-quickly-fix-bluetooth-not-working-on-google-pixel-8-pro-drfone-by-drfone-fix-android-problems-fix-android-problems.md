---
title: How to Quickly Fix Bluetooth Not Working on Google Pixel 8 Pro | Dr.fone
date: 2024-03-20 13:43:58
updated: 2024-03-21 18:35:24
tags: 
  - problems
categories:
  - android
description: This article describes How to Quickly Fix Bluetooth Not Working on Google Pixel 8 Pro
excerpt: This article describes How to Quickly Fix Bluetooth Not Working on Google Pixel 8 Pro
keywords: Google Pixel 8 Pro android fix,Google Pixel 8 Pro android solutions,android help,Google Pixel 8 Pro android support,android problems,android support,android fix
thumbnail: https://www.lifewire.com/thmb/OvgDF4DN2kQY2wqfN-oCDktYpM4=/400x300/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/best-time-of-day-to-instagram-3485858-1-5bb3cc9046e0fb002612537d.jpg
---

## How to Quickly Fix Bluetooth Not Working on Google Pixel 8 Pro
...
Of course, the most common problem to occur with Bluetooth technology in your Google Pixel 8 Pro is when it doesn’t connect to the Google Pixel 8 Pro device you’re trying to link it to. This could be anything from a Bluetooth headset or headphones, to a portable speaker or even an in-car audio system.
...
Since Bluetooth is an internal technology, this indicates there’s a problem with the software or firmware of your Google Pixel 8 Pro. If something’s broken, this means you need to fix it. Fortunately, there’s a quick and easy way to do this using software known as Dr.Fone - System Repair (Android).
...
**Step Two** Connect your Google Pixel 8 Pro to your computer using the USB cable, wait a couple of seconds, and then click the System Repair option. On the Menu on the left, click Android Repair, and then press Start.
...
When the repair process has been completed, you’ll receive the screen below, which means you can try again if the process didn’t work, or you can disconnect your Google Pixel 8 Pro and start using it and your Bluetooth features.
...
1. Turn your Google Pixel 8 Pro off by holding down the Power button
...
Every service on your Google Pixel 8 Pro using a feature called a cache. This is where information is stored to help the feature run properly and give you the best experience. However, over time this can get messy and can cause problems with your Bluetooth feature.
...
Sometimes, you may have a problem with the Google Pixel 8 Pro device you’re trying to connect to via Bluetooth, especially if this is a device you’ve updated. To counter and repair this, you’re going to need to remove the paired devices saved with your device and then reconnect them.

Here’s how;

1. From the Main Menu of your Google Pixel 8 Pro, head to Settings > Bluetooth > Connected Devices.
2. Turn Bluetooth on, and you’ll see all the connections your Google Pixel 8 Pro is paired with
3. Go through these settings and remove/delete/forget every connection on your device
4. Now when you go to connect to a device using Bluetooth, repair the Google Pixel 8 Pro device, enter the passcode, and use a fresh paired connection.
...
If you’re having problems with your connection and paired devices, sometimes you may have conflicting software faults in your device that are causing the problems. If this is the case, you’ll need to boot your Google Pixel 8 Pro in Safe Mode.
...
4. Turn your Bluetooth feature on and connect to the Google Pixel 8 Pro device you’re trying to connect too
...
Sometimes, you might not even have a problem with your Google Pixel 8 Pro, but rather the Bluetooth device you’re trying to connect to, whether that’s a Bluetooth speaker, an in-car entertainment system, or any other kind of Bluetooth device.
...
1. Disconnect your Google Pixel 8 Pro from the Bluetooth device and turn your Bluetooth off
2. Now take another Bluetooth device and connect this to the Google Pixel 8 Pro device you’re trying to connect too. This could be another Android device, or even a computer or iOS device
3. If the new device doesn’t connect to your Bluetooth device, you’ll know there’s a problem with your Bluetooth device, not your Google Pixel 8 Pro
4. If the Google Pixel 8 Pro devices connect, you’ll know there’s a problem with your Google Pixel 8 Pro
...
The further away the Google Pixel 8 Pro devices are from each other, the less likely the connection will remain secure. As a rule of thumb, Bluetooth can work up to 100 meters, but to play it safe, always try and keep your devices under 50m apart.
...
Now that you know how useful the Android System can be, you may want to know how to utilize this feature to get out of some of the problems we mentioned above. Here's how you can safely get to the Android recovery system on your Google Pixel 8 Pro.

Step 1: Hold down the power key and then select "Power Off" from the options on the screen. If, however, your screen is unresponsive, keep holding the power key for several seconds until the Google Pixel 8 Pro device is completely turned off.
...
- Supports all latest Google Pixel 8 Pro devices
...
**Note:** _Be aware that this process can erase all your personal files on your device, so ensure you've [backed up your Google Pixel 8 Pro](https://tools.techidaily.com/wondershare/drfone/android-backup-and-restore/) before continuing._

**Step #1** Head over to the Dr.Fone website and download the software for your Windows computer.

Once installed on your computer, open onto the main menu and connect your Google Pixel 8 Pro using the official USB cable. Select the System Repair option.
...
Step 1: Power off the Google Pixel 8 Pro device, and just to be sure, take out the battery to ensure that the Google Pixel 8 Pro device is fully turned off. Then reinsert the battery.

Step 2: Press and hold down the Home button, Power Button, and the Volume up Key simultaneously until the Google Pixel 8 Pro device vibrates.
...
Step 1: Enter the recovery mode on your Google Pixel 8 Pro, as described in Part 2 above. Use the Volume and Power keys to select the "Backup & Restore" option on the screen.
...
Step 3: After the process is complete, choose "Reboot" to restart the Google Pixel 8 Pro device.
