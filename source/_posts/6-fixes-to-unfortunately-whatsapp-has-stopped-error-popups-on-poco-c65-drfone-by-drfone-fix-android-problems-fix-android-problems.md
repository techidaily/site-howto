---
title: 6 Fixes to Unfortunately WhatsApp has stopped Error Popups On Poco C65 | Dr.fone
date: 2024-05-20T09:03:24.074Z
updated: 2024-05-21T09:03:24.074Z
tags: 
  - problems
categories:
  - android
description: This article describes 6 Fixes to Unfortunately WhatsApp has stopped Error Popups On Poco C65
excerpt: This article describes 6 Fixes to Unfortunately WhatsApp has stopped Error Popups On Poco C65
keywords: android issues,Poco C65 fix android problems,Poco C65 android support,android tips,Poco C65 android fix,android support,android repair,android guide,Poco C65 android troubleshooting,android problems,android troubleshooting,Poco C65 android problems
...
## Google Play Services Won't Update? 12 Fixes are Here on Poco C65
...
- **1\. Incompatibility with Custom ROMs:** Using a custom ROM on your Poco C65 can cause compatibility issues and prevent the installation of Google Play Services updates.
...
Now, taking the assistance of an original USB cable, connect your Poco C65 to the PC. Then hit on “Start”.
...
In most cases, restarting the Poco C65 device can simply do the trick. When you restart the Poco C65 device, most of the issues get eliminated making the Poco C65 device perform better than before. Also, it is all about RAM. While you restart your device, the RAM gets cleared. As a result, the apps work properly. So, in the first place, we would like you to restart your Poco C65 when you cannot update Google Play Services. Once restarted, try to update again and see if the results are positive.
...
- Turn off the Poco C65 device to begin with and then follow the steps for recovery mode.
- On the recovery screen, use the “Volume” buttons for scrolling up and down and go to “Wipe cache partition”.
- To confirm, press the “Power” button. Now, the Poco C65 device will begin to wipe the cache.
- Hit reboot when asked and the Poco C65 device will now be rebooted finishing the issue.
...
Some devices aggressively optimize battery usage, which can interfere with the background processes required for updating Google Play Services. Disable battery optimization for Google Play Services in the Poco C65 device's Settings to ensure uninterrupted updates.
...
To check the version of Google Play Services on your Poco C65, follow these steps:
