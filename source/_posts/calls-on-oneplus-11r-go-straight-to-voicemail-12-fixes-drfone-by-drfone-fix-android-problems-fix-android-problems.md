---
title: Calls on OnePlus 11R Go Straight to Voicemail? 12 Fixes | Dr.fone
date: 2024-07-30T09:53:33.301Z
updated: 2024-07-31T09:53:33.301Z
tags: 
  - problems
categories:
  - android
description: This article describes Calls on OnePlus 11R Go Straight to Voicemail? 12 Fixes
excerpt: This article describes Calls on OnePlus 11R Go Straight to Voicemail? 12 Fixes
keywords: OnePlus 11R android fix,OnePlus 11R android problems,android problems,OnePlus 11R android tips,OnePlus 11R android guide,android issues,OnePlus 11R android help,android solutions,android repair
thumbnail: https://thmb.techidaily.com/93e8b8eb6bc88169936766a6461fe23e663eb59793bd9736b13ed221555fa6ea.jpg
---

## Calls on OnePlus 11R Go Straight to Voicemail? 12 Fixes
...
If a phone **call went straight to voicemail**, another possible explanation is the call barring. It is a feature that restricts calls from being made or received on your phone. If activated, it can cause incoming calls to a phone to go straight to voicemail. To turn off call barring on OnePlus 11R devices:
...
- **Step 1:** Open the **Google One** app on your OnePlus 11R.
...
- **Step 3:** Select **Android** as the OnePlus 11R device type.
...
- **Step 5:** Select the OnePlus 11R device details on the **Name**, **Model**, **Country**, and **Carrier** drop-down lists. Next, select the agreement checkbox, then click **Next** to proceed.
...
- **Step 6:** Follow the in-app instructions to enter Download mode on your OnePlus 11R, then click **Next**.
...
- **Step 8:** Enter the code in the input box to verify the OnePlus 11R device information in the dialogue box, then click **Confirm**.

![confirm device information](https://images.wondershare.com/drfone/guide/android-system-repair-7.png)

- **Step 9:** The app will start repairing the system issue on your OnePlus 11R. Once completed, your app should restart, then click **Done** to close the app.
...
## Fixes for Apps Keep Crashing on OnePlus 11R
...
- ****Step 1:**** On your OnePlus 11R, move the app icon and press it to select “App Info.” On the App Info screen, tap the “Force Stop” button to force close the app. The button can be either on the down left or down right corner.
...
In case restarting the app hasn’t worked, you should try restarting your OnePlus 11R. Rebooting your device reset all the processes and apps in the OnePlus 11R device. It helps remove conflicts between different apps, which can be the cause of your ****apps keep crashing on Android****. To reboot your OnePlus 11R, adhere to the following guidelines:

- ****Step:**** Press and hold the “Power” key until you see the power menu on the screen. Here, tap the “Restart/Reboot” button to restart your OnePlus 11R.
...
Not updating your Android OS for a long while can cause many performance issues in your device. One of these issues is the incompatibility with the latest apps. That's why make sure that your OnePlus 11R is running the latest available version of the operating system. You can check and update the Android OS of your device using these steps:

- ****Step 1:**** Launch the Settings app on your OnePlus 11R and scroll down to select “Software Update.” On the next screen, tap “Download and Install” to look for new updates.
...
- ****Step 1:**** You will need to launch Settings on your OnePlus 11R and tap “Apps.” Here find and select the targeted app to open App Info.
...
Insufficient storage space on your device can also lead to app crashes. Check the available storage space on your OnePlus 11R and ensure it has enough free space. If the storage is full, consider deleting unnecessary files or apps to create more space. Explained below is the process to check and free up storage on Android devices:

- ****Step 1:**** Open Settings on your OnePlus 11R and scroll down to find and select “Battery and Device Care.” Here, tap “Storage” to view the OnePlus 11R device storage.
...
- ****Step 2:**** Press the “Power Off” button until “Restart in Safe Mode” appears on the screen. Now reboot the OnePlus 11R device into Safe Mode. To exit Safe Mode, you will need to restart the phone.
...
- Wondershare Dr.Fone is a specialized tool for fixing problems with OnePlus 11R devices, including the latest OnePlus 11R phones.
...
Open Wondershare Dr.Fone on your system after installation and select “System Repair” from the “Toolbox.” Now connect your OnePlus 11R using a USB cable and select “Android” in Wondershare Dr.Fone.
