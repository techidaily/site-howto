---
title: How to Quickly Fix Bluetooth Not Working on Poco X5 | Dr.fone
date: 2024-03-19 17:46:26
updated: 2024-03-21 21:40:31
tags: 
  - problems
categories:
  - android
description: This article describes How to Quickly Fix Bluetooth Not Working on Poco X5
excerpt: This article describes How to Quickly Fix Bluetooth Not Working on Poco X5
keywords: Poco X5 android issues,fix android problems,android tips,android troubleshooting,Poco X5 android problems,Poco X5 android tips,android repair
thumbnail: https://www.lifewire.com/thmb/rmV5FQdusxtcDMfMN-dk_OtLxwI=/400x300/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/MorningShow-aed160f9cfd448cc8034b23bb3073314.jpg
---

## How to Quickly Fix Bluetooth Not Working on Poco X5
...
Of course, the most common problem to occur with Bluetooth technology in your Poco X5 is when it doesn’t connect to the Poco X5 device you’re trying to link it to. This could be anything from a Bluetooth headset or headphones, to a portable speaker or even an in-car audio system.
...
**Step Two** Connect your Poco X5 to your computer using the USB cable, wait a couple of seconds, and then click the System Repair option. On the Menu on the left, click Android Repair, and then press Start.
...
When the repair process has been completed, you’ll receive the screen below, which means you can try again if the process didn’t work, or you can disconnect your Poco X5 and start using it and your Bluetooth features.
...
1. Turn your Poco X5 off by holding down the Power button
...
Every service on your Poco X5 using a feature called a cache. This is where information is stored to help the feature run properly and give you the best experience. However, over time this can get messy and can cause problems with your Bluetooth feature.
...
Sometimes, you may have a problem with the Poco X5 device you’re trying to connect to via Bluetooth, especially if this is a device you’ve updated. To counter and repair this, you’re going to need to remove the paired devices saved with your device and then reconnect them.

Here’s how;

1. From the Main Menu of your Poco X5, head to Settings > Bluetooth > Connected Devices.
2. Turn Bluetooth on, and you’ll see all the connections your Poco X5 is paired with
3. Go through these settings and remove/delete/forget every connection on your device
4. Now when you go to connect to a device using Bluetooth, repair the Poco X5 device, enter the passcode, and use a fresh paired connection.
...
If you’re having problems with your connection and paired devices, sometimes you may have conflicting software faults in your device that are causing the problems. If this is the case, you’ll need to boot your Poco X5 in Safe Mode.
...
4. Turn your Bluetooth feature on and connect to the Poco X5 device you’re trying to connect too
...
Sometimes, you might not even have a problem with your Poco X5, but rather the Bluetooth device you’re trying to connect to, whether that’s a Bluetooth speaker, an in-car entertainment system, or any other kind of Bluetooth device.
...
1. Disconnect your Poco X5 from the Bluetooth device and turn your Bluetooth off
2. Now take another Bluetooth device and connect this to the Poco X5 device you’re trying to connect too. This could be another Android device, or even a computer or iOS device
3. If the new device doesn’t connect to your Bluetooth device, you’ll know there’s a problem with your Bluetooth device, not your Poco X5
4. If the Poco X5 devices connect, you’ll know there’s a problem with your Poco X5
...
The further away the Poco X5 devices are from each other, the less likely the connection will remain secure. As a rule of thumb, Bluetooth can work up to 100 meters, but to play it safe, always try and keep your devices under 50m apart.
...
Here, we are going to mention four common methods that you can try to resolve the home button problem on your Poco X5 with ease.
...
- It is compatible with all Poco X5 devices.
...
Step 2: Thereafter, connect your Poco X5 to the computer using a USB cable and select the “Android Repair” tab from the left menu.
...
## Fix Can't Take Screenshot Due to Security Policy on Poco X5
...
Say you’re trying to take a screenshot on your Poco X5 device, and you get the notification “**Can’t take screenshot due to security policy.” Poco X5** smartphones are not necessarily the problem.
...
Sudden “**can’t take screenshot due to security policy**” notifications, failing to take a screenshot, and a Poco X5 user?
...
- **Step 1:** Open Chrome on your Poco X5 and type “chrome://flags” in the address bar.
...
With Google Assistant, taking screenshots on your Poco X5 is now easier than ever. Just say, “Hey, Google, take a screenshot,” Google Assistant will capture the screen and save it to your gallery.
...
Smart View allows you to display your Poco X5 device’s screen on your smart TV, where you can then take a screenshot of the TV to capture the app or website you need.
...
Alternatively, if you don’t have a smart TV, you can still mirror your phone screen display to your desktop or tablet using the Poco X5 Flow app and take a screenshot of your phone’s screen instead.
...
- **Step 1:** Once you have downloaded Dr.Fone, install it and launch it on your desktop. Then, connect your Poco X5 to your desktop using a USB cable.
...
- **Step 5:** Follow the in-app instructions to put your Poco X5 on Download mode, then click **Next**.
