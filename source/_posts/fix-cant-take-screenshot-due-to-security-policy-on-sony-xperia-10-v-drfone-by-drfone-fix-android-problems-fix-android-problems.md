---
title: Fix Cant Take Screenshot Due to Security Policy on Sony Xperia 10 V | Dr.fone
date: 2024-07-30T10:18:35.757Z
updated: 2024-07-31T10:18:35.757Z
tags: 
  - problems
categories:
  - android
description: This article describes Fix Cant Take Screenshot Due to Security Policy on Sony Xperia 10 V
excerpt: This article describes Fix Cant Take Screenshot Due to Security Policy on Sony Xperia 10 V
keywords: Sony Xperia 10 V android problems,android support,Sony Xperia 10 V android issues,Sony Xperia 10 V android tips,Sony Xperia 10 V fix android problems,android troubleshooting,android guide
thumbnail: https://thmb.techidaily.com/1b6976e6cb0861a8e856af8d9b91eb1dc370f068cc6322414a1134e31c0876a0.jpg
---

## Fix Can't Take Screenshot Due to Security Policy on Sony Xperia 10 V
...
Say you’re trying to take a screenshot on your Sony Xperia 10 V device, and you get the notification “**Can’t take screenshot due to security policy.” Sony Xperia 10 V** smartphones are not necessarily the problem.
...
Sudden “**can’t take screenshot due to security policy**” notifications, failing to take a screenshot, and a Sony Xperia 10 V user?
...
- **Step 3:** Enable **Sony Xperia 10 V capture**.
...
- **Step 1:** Open Chrome on your Sony Xperia 10 V and type “chrome://flags” in the address bar.
...
With Google Assistant, taking screenshots on your Sony Xperia 10 V is now easier than ever. Just say, “Hey, Google, take a screenshot,” Google Assistant will capture the screen and save it to your gallery.
...
Smart View allows you to display your Sony Xperia 10 V device’s screen on your smart TV, where you can then take a screenshot of the TV to capture the app or website you need.
...
Alternatively, if you don’t have a smart TV, you can still mirror your phone screen display to your desktop or tablet using the Sony Xperia 10 V Flow app and take a screenshot of your phone’s screen instead.
...
- **Step 1:** Once you have downloaded Dr.Fone, install it and launch it on your desktop. Then, connect your Sony Xperia 10 V to your desktop using a USB cable.
...
- **Step 5:** Follow the in-app instructions to put your Sony Xperia 10 V on Download mode, then click **Next**.
...
<!-- affiliate ads end -->
## Sony Xperia 10 V Not Connecting to Wi-Fi? 12 Quick Ways to Fix

Nowadays, it’s pretty much essential to have your Sony Xperia 10 V or smartphone connected to the internet. Whether you’re watching videos, looking something up, or using any kind of app, you need the internet for these applications to function correctly.
...
Luckily, despite there being so many problems out there, there are also many solutions. Today, we’re going to share with you the complete definitive guide to help you get your Sony Xperia 10 V connected and free from problems and issues.

## Part 1: Restart your Sony Xperia 10 V

Begin by powering off your Sony Xperia 10 V and unplugging your router. Wait for about a minute before plugging in the router and turning on your device. This simple reset can often restore stable connections and fix Android wifi not working.
...
The third step you’ll want to take is making sure the internet router in your house is working properly and is actually sending internet data to your Sony Xperia 10 V. Of course, if you have other internet-enabled devices connected to the same router and they’re working fine, you know this isn’t the problem.
...
5. Open your web browser and log into your router settings to ensure your Sony Xperia 10 V is connected to the Wi-Fi network and is allowed to send and receive data
...
If you’re unable to connect to the internet, but other devices have no issues, you may find the issues is coming from within your Sony Xperia 10 V itself. Fortunately, there are ways you can see whether this is the problem.

The best way to do this is to boot your device in Safe Mode. The process for doing this will depend on the make and model of your Sony Xperia 10 V, but the basic process goes as follows;

1. Turn off your Sony Xperia 10 V by holding down the Power button and tapping Power Off. Wait a few minutes to ensure the Sony Xperia 10 V device is completely off
...
3. You will see the words ‘Safe Mode’ appear on your screen as the Sony Xperia 10 V device loads
...
If you’re using a Wi-Fi adapter on your device to connect to the internet, you’ll need to make sure this is working. This could be an adapter on your Sony Xperia 10 V itself, especially if you’re using an older device, or if you’re using an adapter to boost the ranger of your router network.

You need to check both of these to make sure your connection is working properly.

1. If using an Android Wi-Fi adapter, make sure all the Sony Xperia 10 V device drivers are up to date, and if you’re using an app, make sure the app is updated, and all the settings allow an internet connection
2. If you’re using a router adapter, make sure it’s set up properly, and your Sony Xperia 10 V is connected to the adapter using the correct passwords. Try connecting another device to see if the internet connection is working on there
3. Whichever method you’re using, try disconnecting your Sony Xperia 10 V and forgetting the network, and then reconnecting and entering the right password to refresh the connection
...
To make a Wi-Fi connection work, your Sony Xperia 10 V needs to match two codes that connect and relate to your router to establish the connection and work correctly. These are known as the SSID and the IP address.

Every wireless device will have its own codes and making sure they’re matched to the network you’re connecting to is crucial to ensuring the internet is working on your Sony Xperia 10 V. Here’s how to check on your Sony Xperia 10 V to make sure everything is correct.

1. Tap the Settings menu option, followed by Wi-Fi on your Sony Xperia 10 V
...
If none of the solutions above are working, this could indicate a real problem with the firmware and operating system of your Sony Xperia 10 V. Fortunately, a fast solution to get everything working again is to completely repair the software of your phone.
...
Once installed, connect your Sony Xperia 10 V to your computer using a USB cable, and open the software, click "System Repair".
...
5. Now connect your Sony Xperia 10 V to the router using the new password
...
Just like the method above where you’ll be effectively resetting the network settings on your router, if this hasn’t worked, you’ll be able to reset the network settings on your Sony Xperia 10 V, hopefully removing the bugs and allowing you to connect.

Here’s how you can do this easily on your Sony Xperia 10 V;

1. From the home screen of your Sony Xperia 10 V, open the Settings menu
2. Tap the Backup & Reset option
3. Tap the Reset Network Settings option
4. Tap the Reset Network option
5. If you need to, enter the PIN number or passcode for the Android device, and the Sony Xperia 10 V device will confirm the reset has taken place
6. Reconnect your Sony Xperia 10 V to your Wi-Fi network for the changes to take effect
...
As you continue to use your Sony Xperia 10 V, the partition cache will fill up with data your device needs and doesn’t need. However, by clearing your device’s partition cache, you can make clear up some space which should help your device have enough memory to connect to the internet.

1. Turn off your Sony Xperia 10 V
...
If worse comes to worst, another option you have is to factory reset your Sony Xperia 10 V. As we’ve spoken about above, while using your phone from the day you started using it, your device will fill up with files and data which can become messy and causes bugs.
...
1. Open the Settings menu on your Sony Xperia 10 V
...
## Stuck at Android System Recovery Of Sony Xperia 10 V ? Fix It Easily
...
Despite all the worry that surrounds an unwanted Android system recovery screen, it is actually a feature that can be quite helpful to your Sony Xperia 10 V when it's needed. It can be useful when you want to hard reset the Android device without having to access the settings. This can be very useful if your device is not working very well or if your touch screen is experiencing problems. It can also be very helpful when you are having a problem accessing the settings on your device.
...
Now that you know how useful the Android System can be, you may want to know how to utilize this feature to get out of some of the problems we mentioned above. Here's how you can safely get to the Android recovery system on your Sony Xperia 10 V.

Step 1: Hold down the power key and then select "Power Off" from the options on the screen. If, however, your screen is unresponsive, keep holding the power key for several seconds until the Sony Xperia 10 V device is completely turned off.
...
- Supports all latest Sony Xperia 10 V devices
...
**Note:** _Be aware that this process can erase all your personal files on your device, so ensure you've [backed up your Sony Xperia 10 V](https://tools.techidaily.com/wondershare/drfone/android-backup-and-restore/) before continuing._

**Step #1** Head over to the Dr.Fone website and download the software for your Windows computer.

Once installed on your computer, open onto the main menu and connect your Sony Xperia 10 V using the official USB cable. Select the System Repair option.
...
Step 1: Power off the Sony Xperia 10 V device, and just to be sure, take out the battery to ensure that the Sony Xperia 10 V device is fully turned off. Then reinsert the battery.

Step 2: Press and hold down the Home button, Power Button, and the Volume up Key simultaneously until the Sony Xperia 10 V device vibrates.
...
Losing data on your Sony Xperia 10 V is a common occurrence, and since Android devices don't really have an automatic full backup solution, it is important to know how to backup and restore your device system. Here's how to easily do that.

Step 1: Enter the recovery mode on your Sony Xperia 10 V, as described in Part 2 above. Use the Volume and Power keys to select the "Backup & Restore" option on the screen.
...
Step 3: After the process is complete, choose "Reboot" to restart the Sony Xperia 10 V device.
