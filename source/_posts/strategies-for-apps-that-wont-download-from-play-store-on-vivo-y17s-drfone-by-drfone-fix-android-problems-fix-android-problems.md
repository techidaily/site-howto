---
title: Strategies for Apps That Wont Download From Play Store On Vivo Y17s | Dr.fone
date: 2024-08-08T21:08:43.158Z
updated: 2024-08-09T21:08:43.158Z
tags: 
  - problems
categories:
  - android
description: This article describes Strategies for Apps That Wont Download From Play Store On Vivo Y17s
excerpt: This article describes Strategies for Apps That Wont Download From Play Store On Vivo Y17s
keywords: Vivo Y17s android issues,Vivo Y17s android solutions,android help,android support,android guide,android repair,Vivo Y17s android fix,android solutions
...
Authentication error occurs when the “deal” between the Wi-Fi router and device fails due to certain reasons. First, the Vivo Y17s device sends the password of the network and the "connect" request in an encrypted format to the Wi-Fi router. Then, the router decrypts the password and compares the password saved on it. Now, if the password matches, it sends affirmation for the "connect" request, and then the Vivo Y17s device is allowed to connect to the network.
...
1. Connect your Vivo Y17s to the computer, and select "Android Repair" in the middle.
...
1. Next up, you should boot your Vivo Y17s in download mode by following the on-screen instructions.
...
Step 1: Head to the “Settings” of your Vivo Y17s and then opt for “Wireless and Networks” followed by “WLAN/WiFi”.

Step 2: Now, hit on the WiFi network that is showing "authentication error occurred".

Step 3: Depending on your Vivo Y17s model, look for “IP Settings” and tap on it. Now, switch the “DHCP” to “Static”.
...
There are instances where an outdated OS version of your Vivo Y17s may create a hindrance in establishing a connection between your device and the WiFi network. You need to update your Android firmware to the latest version and then check if the problem persists or not.

Step 1: Launch “Settings” of your Vivo Y17s and then get into the “About Phone” option.
