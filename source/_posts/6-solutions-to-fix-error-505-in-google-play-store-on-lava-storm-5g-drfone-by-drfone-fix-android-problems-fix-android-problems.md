---
title: 6 Solutions to Fix Error 505 in Google Play Store on Lava Storm 5G | Dr.fone
date: 2024-07-30T07:44:45.745Z
updated: 2024-07-31T07:44:45.745Z
tags: 
  - problems
categories:
  - android
description: This article describes 6 Solutions to Fix Error 505 in Google Play Store on Lava Storm 5G
excerpt: This article describes 6 Solutions to Fix Error 505 in Google Play Store on Lava Storm 5G
keywords: Lava Storm 5G android guide,Lava Storm 5G android problems,android guide,Lava Storm 5G android issues,Lava Storm 5G android help,Lava Storm 5G fix android problems,Lava Storm 5G android troubleshooting,Lava Storm 5G android repair
thumbnail: https://thmb.techidaily.com/bdaef56e02cc4aa00f3e70ad3df4b912e80b691b8ee44c6197adf88943656c52.jpg
---

## 6 Solutions to Fix Error 505 in Google Play Store on Lava Storm 5G
...
- Supports all the new Lava Storm 5G devices like Galaxy S8, S9, etc.
...
Step5: After the Lava Storm 5G device firmware is downloaded, the tool will start repairing your Android.
...
\>Select the Application Manger or App (Option depends upon the Lava Storm 5G device)

At the top, an option will appear

\>Swipe right till you locate Download manager at top of the screen of the Lava Storm 5G device

\>Then Select Enable

![Application Manger](https://images.wondershare.com/drfone/article/2017/06/14976274734570.jpg)

Enabling download manager to give permission to the Lava Storm 5G device to start the download or installation process.

#### **Solution 3: Updating to the latest version of OS of your Lava Storm 5G**
...
## 8 Ultimate Fixes for Google Play Your Lava Storm 5G Isn't Compatible
...
- **Step 1.** On your Lava Storm 5G, find the Google Play Store and long-press its icon. Press "App info" from the pop-up menu to access the app information screen.
...
An outdated operating system is a common factor behind compatibility issues. This case is often used with Google Play Store and other important apps. Maintaining your Lava Storm 5G's compatibility with the latest app releases is essential. To ensure your Android operating system is up-to-date, please proceed with the following steps:

**Instructions.** You will need to start by accessing the Lava Storm 5G device's “Settings.” Scroll down to find and press the "System" option. On the following screen, tap "Software Update" to check if an update is available. If there is one, follow the on-screen prompts to update your device's OS.
...
- **Step 1.** Using your Lava Storm 5G's Settings, access the Google Play Store app in the "Apps" tab. Once on its info page, tap the three dots icon from the top right corner.
...
1. Fone – System Repair (Android) allows you to repair your Lava Storm 5G easily in just a few clicks.
...
After that, you need to enter the Lava Storm 5G device details like the “Name, Model, Brand, etc.” and put your phone on a Download Mode. Following this step, the firmware will download on its own, and you need to click the “Fix Now” button to install it on your Lava Storm 5G.
...
In the last step, you will have to put in the code and proceed with the “Confirm” button to initiate the repair process. This may delete all your data in the Lava Storm 5G device, and once it has ended, select the “Done” button to conclude the process.
...
<!-- affiliate ads end -->
## How To Fix Part of the Touch Screen Not Working on Lava Storm 5G
...
There are two possible causes as to why your phone’s touch screen is not working. One is the touch screen may have been damaged, and the other is the Lava Storm 5G device may be experiencing technical difficulties.
...
- Lava Storm 5G P40 lite ****half touch screen not working****
- Nexus touch screen not working
- LG screen is unresponsive to touch
- Lava Storm 5G ****left side of the screen is not working****
...
- Remove the Lava Storm 5G device cover and screen protector if they are not damaged.
- If there is a sticker on the Lava Storm 5G device screen, you must remove it.
...
If you have already tried running the Lava Storm 5G device in diagnostic mode and verified that it is not physically damaged, then the problem is most likely technical. If your Lava Storm 5G’s screen is not responding to touches for technical reasons, follow the methods below to resolve the issue.
...
****Step 1:**** Hold the “Power” button until the Lava Storm 5G device turns off.
...
****Step 2:**** When the Lava Storm 5G device turns off, wait a few seconds.

****Step 3:**** Press and hold the “Power” button to restart the Lava Storm 5G device.
...
****Step 1:**** To force a restart, press and hold the Lava Storm 5G device’s “Power” button for an extended period.
...
****Step 2:**** Connect your Lava Storm 5G or tablet to the computer using the appropriate cable. Choose ****Android Repair**** from the three options shown on the left side of the screen.
...
****Step 4:**** Before repairing your Lava Storm 5G, you must boot it into ****Download**** ****mode****. To boot your Lava Storm 5G or tablet into DFU mode, follow the steps below:
...
1. Turn off the Lava Storm 5G device.
...
****Step 5:**** Then press the ****Next**** button. The program will then download the firmware. After downloading and verifying the firmware, the program will automatically repair your Lava Storm 5G. And in a while, your Lava Storm 5G’s system issues will be resolved.
...
That’s why Dr.Fone – System Repair might be your best solution. It has all the tools you need to keep your Lava Storm 5G 100%. Not only that, but with Dr.Fone, you can repair your Android system issues without dealing with any data loss.
