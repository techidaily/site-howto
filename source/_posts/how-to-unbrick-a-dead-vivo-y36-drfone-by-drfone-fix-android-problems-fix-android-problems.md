---
title: How To Unbrick a Dead Vivo Y36 | Dr.fone
date: 2024-03-18 19:58:30
updated: 2024-03-21 15:45:26
tags: 
  - problems
categories:
  - android
description: This article describes How To Unbrick a Dead Vivo Y36
excerpt: This article describes How To Unbrick a Dead Vivo Y36
keywords: android guide,Vivo Y36 android issues,Vivo Y36 android problems,android issues,android support,Vivo Y36 android troubleshooting,Vivo Y36 fix android problems
...
## Calls on Vivo Y36 Go Straight to Voicemail? 12 Fixes
...
If a phone **call went straight to voicemail**, another possible explanation is the call barring. It is a feature that restricts calls from being made or received on your phone. If activated, it can cause incoming calls to a phone to go straight to voicemail. To turn off call barring on Vivo Y36 devices:
...
- **Step 1:** Open the **Google One** app on your Vivo Y36.
...
Dr.Fone supports over 1000 Android models, including unlocked Vivo Y36 models and models from carriers like [<u>AT&amp;T</u>](https://drfone.wondershare.com/sim-unlock/how-to-unlock-att-iphone.html) and Vodafone. It has an intuitive interface and is easy to use, even for beginners. Learn below the steps on how to use Dr.Fone System Repair to fix incoming calls that **dial straight to voicemail**:
...
- **Step 3:** Select **Android** as the Vivo Y36 device type.
...
- **Step 5:** Select the Vivo Y36 device details on the **Name**, **Model**, **Country**, and **Carrier** drop-down lists. Next, select the agreement checkbox, then click **Next** to proceed.

![choose device information to repair](https://images.wondershare.com/drfone/guide/android-system-repair-2.png)

- **Step 6:** Follow the in-app instructions to enter Download mode on your Vivo Y36, then click **Next**.
...
- **Step 8:** Enter the code in the input box to verify the Vivo Y36 device information in the dialogue box, then click **Confirm**.

![confirm device information](https://images.wondershare.com/drfone/guide/android-system-repair-7.png)

- **Step 9:** The app will start repairing the system issue on your Vivo Y36. Once completed, your app should restart, then click **Done** to close the app.
...
## 8 Solutions to Solve YouTube App Crashing on Vivo Y36
...
Similar to the app, if you restart the Vivo Y36 device, it will start operating properly making the YouTube app work better than before. So, as the next tip, please restart your device.
...
The apps that run on the internet might start crashing due to connectivity issues. Therefore, resetting the network settings once can work as a great remedy to follow when YouTube has stopped on your Vivo Y36. This will remove all your network settings like Wi-Fi passwords etc.
...
With the help of the USB cord, connect your Vivo Y36 to the computer. Click on “Android Repair” now from the left panel.
...
When nothing works, the last resort you can go with is resetting the Vivo Y36 device to factory state. Doing this will remove any sort of conflicting bugs and other stuff. However, this will remove the data from your device. So make sure to backup everything before going with this method. The steps are:
